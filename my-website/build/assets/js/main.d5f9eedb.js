 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 *//* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function(){return null;});
...
exports.LU='__blog-post-container';var applyTrailingSlash_1=__webpack_require__(2983);Object.defineProperty(exports, "Ks", ({enumerable:true,get:function get(){return tslib_1.__importDefault(applyTrailingSlash_1)["default"];}}));__webpack_unused_export__ = ({enumerable:true,get:function get(){return applyTrailingSlash_1.addTrailingSlash;}});__webpack_unused_export__ = ({enumerable:true,get:function get(){return applyTrailingSlash_1.addLeadingSlash;}});__webpack_unused_export__ = ({enumerable:true,get:function get(){return applyTrailingSlash_1.removeTrailingSlash;}});var stringUtils_1=__webpack_require__(2566);__webpack_unused_export__ = ({enumerable:true,get:function get(){return stringUtils_1.addPrefix;}});__webpack_unused_export__ = ({enumerable:true,get:function get(){return stringUtils_1.removeSuffix;}});__webpack_unused_export__ = ({enumerable:true,get:function get(){return stringUtils_1.addSuffix;}});__webpack_unused_export__ = ({enumerable:true,get:function get(){return stringUtils_1.removePrefix;}});var errorUtils_1=__webpack_require__(253);Object.defineProperty(exports, "rA", ({enumerable:true,get:function get(){return errorUtils_1.getErrorCausalChain;}}));
 ...
 */function DocsSidebarProvider(_ref){var children=_ref.children,name=_ref.name,items=_ref.items;var stableValue=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function(){return name&&items?{name:name,items:items}:null;},[name,items]);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(Context.Provider,{value:stableValue,children:children});}/**
 * Gets the sidebar that's currently displayed, or `null` if there isn't one
 */function useDocsSidebar(){var value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(value===EmptyContext){throw new _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_1__/* .ReactContextError */ .dV('DocsSidebarProvider');}return value;}
...
var _useState=useState(function(){if(key===null){return NoopStorageSlot;}return createStorageSlot(key,options);}),storageSlot=_useState[0];var listen=useCallback(function(onChange){// Do not try to add a listener during SSR
if(typeof window==='undefined'){return function(){};}return storageSlot.listen(onChange);},[storageSlot]);var currentValue=useSyncExternalStore(listen,function(){// react-test-renderer (deprecated) never call getServerSnapshot() :/
if(false)// removed by dead control flow
{}return storageSlot.get();},function(){return null;});return[currentValue,storageSlot];}/**
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function Heading(_ref){var As=_ref.as,id=_ref.id,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var brokenLinks=(0,useBrokenLinks/* default */.A)();var anchorTargetClassName=(0,anchorUtils/* useAnchorTargetClassName */.v)(id);// H1 headings do not need an id because they don't appear in the TOC.
if(As==='h1'||!id){return/*#__PURE__*/(0,jsx_runtime.jsx)(As,Object.assign({},props,{id:undefined}));}brokenLinks.collectAnchor(id);var anchorTitle=(0,Translate/* translate */.T)({id:'theme.common.headingLinkTitle',message:'Direct link to {heading}',description:'Title for link to heading'},{heading:typeof props.children==='string'?props.children:id});return/*#__PURE__*/(0,jsx_runtime.jsxs)(As,Object.assign({},props,{className:(0,clsx/* default */.A)('anchor',anchorTargetClassName,props.className),id:id,children:[props.children,/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{className:"hash-link",to:"#"+id,"aria-label":anchorTitle,title:anchorTitle,translate:"no",children:"\u200B"})]}));}
...
/* harmony export */ });
/* harmony import */ var D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8587);
...
el.style.willChange='height';function startAnimation(){var animationFrame=requestAnimationFrame(function(){// When collapsing
...
else{el.style.display='block';requestAnimationFrame(function(){applyTransitionStyles();});}});return function(){return cancelAnimationFrame(animationFrame);};}return startAnimation();},[collapsibleRef,collapsed,animation]);}function CollapsibleBase(_ref3){var _ref3$as=_ref3.as,As=_ref3$as===void 0?'div':_ref3$as,collapsed=_ref3.collapsed,children=_ref3.children,animation=_ref3.animation,onCollapseTransitionEnd=_ref3.onCollapseTransitionEnd,className=_ref3.className;var collapsibleRef=(0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);useCollapseAnimation({collapsibleRef:collapsibleRef,collapsed:collapsed,animation:animation});return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(As// @ts-expect-error: the "too complicated type" is produced from
// "CollapsibleElementType" being a huge union
,{ref:collapsibleRef// Refs are contravariant, which is not expressible in TS
,onTransitionEnd:function onTransitionEnd(e){if(e.propertyName!=='height'){return;}applyCollapsedStyle(collapsibleRef.current,collapsed);onCollapseTransitionEnd==null||onCollapseTransitionEnd(collapsed);},className:className,children:children});}function CollapsibleLazy(_ref4){var collapsed=_ref4.collapsed,props=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_ref4,_excluded);var _useState2=(0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(!collapsed),mounted=_useState2[0],setMounted=_useState2[1];// Updated in effect so that first expansion transition can work
var _useState3=(0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(collapsed),lazyCollapsed=_useState3[0],setLazyCollapsed=_useState3[1];(0,_docusaurus_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(function(){if(!collapsed){setMounted(true);}},[collapsed]);(0,_docusaurus_useIsomorphicLayoutEffect__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(function(){if(mounted){setLazyCollapsed(collapsed);}},[mounted,collapsed]);return mounted?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(CollapsibleBase,Object.assign({},props,{collapsed:lazyCollapsed})):null;}/**
 ...
 */function Collapsible(_ref5){var lazy=_ref5.lazy,props=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_ref5,_excluded2);var Comp=lazy?CollapsibleLazy:CollapsibleBase;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(Comp,Object.assign({},props));}
...
var BACKEND_URL="http://localhost:8000/ask";function ChatWidget(){var _useState=(0,react.useState)(false),isOpen=_useState[0],setIsOpen=_useState[1];var _useState2=(0,react.useState)([]),messages=_useState2[0],setMessages=_useState2[1];var _useState3=(0,react.useState)(""),userInput=_useState3[0],setUserInput=_useState3[1];var _useState4=(0,react.useState)(false),loading=_useState4[0],setLoading=_useState4[1];var _useState5=(0,react.useState)(false),isListening=_useState5[0],setIsListening=_useState5[1];var messagesEndRef=(0,react.useRef)(null);var recognitionRef=(0,react.useRef)(null);// 🎤 Voice Recognition Setup
(0,react.useEffect)(function(){var SpeechRecognition=window.SpeechRecognition||window.webkitSpeechRecognition;if(SpeechRecognition){var recog=new SpeechRecognition();recog.lang="en-US";recog.continuous=false;recog.onresult=function(event){var text=event.results[0][0].transcript;setUserInput(text);};recog.onend=function(){return setIsListening(false);};recognitionRef.current=recog;}},[]);var startVoiceInput=function startVoiceInput(){if(!recognitionRef.current)return;setIsListening(true);recognitionRef.current.start();};// ⌨ Typewriter Effect
var typeWriter=function typeWriter(text,callback){var index=0;var display="";var interval=setInterval(function(){display+=text[index];callback(display);index++;if(index>=text.length)clearInterval(interval);},20);};// Auto Scroll
(0,react.useEffect)(function(){var _messagesEndRef$curre;(_messagesEndRef$curre=messagesEndRef.current)==null||_messagesEndRef$curre.scrollIntoView({behavior:"smooth"});},[messages]);// ⭐ AUTO WELCOME MESSAGE WHEN CHAT OPENS
(0,react.useEffect)(function(){if(isOpen&&messages.length===0){var welcomeMsg={sender:"bot",text:"\uD83D\uDC4B Hi! I'm your MJ AI assistant.  \nAsk me anything about Physical AI, ROS2, Gazebo, Isaac Sim, or Humanoid Robotics!  \nI can also explain any part of your textbook \u2014 just type your question.",time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})};setMessages([welcomeMsg]);}},[isOpen]);// ➤ Send Message
var sendMessage=/*#__PURE__*/function(){var _ref=(0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee(){var newMessage,res,data,botText,temp,_t;return (0,regenerator/* default */.A)().w(function(_context){while(1)switch(_context.p=_context.n){case 0:if(userInput.trim()){_context.n=1;break;}return _context.a(2);case 1:newMessage={sender:"user",text:userInput,time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})};setMessages(function(prev){return[].concat(prev,[newMessage]);});setUserInput("");setLoading(true);_context.p=2;_context.n=3;return fetch(BACKEND_URL,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({question:userInput})});case 3:res=_context.v;_context.n=4;return res.json();case 4:data=_context.v;botText=data.answer||"No response 😢";temp={sender:"bot",text:"",time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})};setMessages(function(prev){return[].concat(prev,[temp]);});typeWriter(botText,function(typed){temp.text=typed;setMessages(function(prev){return[].concat(prev.slice(0,-1),[Object.assign({},temp)]);});});_context.n=6;break;case 5:_context.p=5;_t=_context.v;setMessages(function(prev){return[].concat(prev,[{sender:"bot",text:"⚠️ Backend unreachable.",time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}]);});case 6:setLoading(false);case 7:return _context.a(2);}},_callee,null,[[2,5]]);}));return function sendMessage(){return _ref.apply(this,arguments);};}();return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"chat-particles"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("button",{className:"chatbot-button \n          "+(loading?"orb-thinking":"")+" \n          "+(isListening?"orb-listening":""),onClick:function onClick(){return setIsOpen(!isOpen);},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"orb-core"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"orb-waves"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"orb-rotate"})]}),isOpen&&/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"neon-overlay"}),isOpen&&/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"chatbot-window fade-in-scale",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"chatbot-header",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"hologram-bot"}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:"MJ AI Chatbot"}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:function onClick(){return setIsOpen(false);},children:"\u2716"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"chatbot-messages",children:[messages.map(function(msg,i){return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"chat-row "+msg.sender,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"chat-message "+msg.sender,children:msg.text}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"timestamp",children:msg.time})]},i);}),loading&&/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"typing-indicator",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{ref:messagesEndRef})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"chatbot-input",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("button",{className:"mic-button "+(isListening?"mic-active":""),onClick:startVoiceInput,children:"\uD83C\uDFA4"}),/*#__PURE__*/(0,jsx_runtime.jsx)("input",{value:userInput,onChange:function onChange(e){return setUserInput(e.target.value);},placeholder:"Ask something...",onKeyDown:function onKeyDown(e){return e.key==="Enter"&&sendMessage();}}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:sendMessage,children:"Send"})]})]})]});}
;// ./src/theme/Root.tsx
function Root(_ref){var children=_ref.children;return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[children,/*#__PURE__*/(0,jsx_runtime.jsx)(ChatWidget,{})]});}
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/titleFormatterUtils.js
var titleFormatterUtils = __webpack_require__(4563);
;// ./node_modules/@docusaurus/theme-classic/lib/theme/ThemeProvider/TitleFormatter/index.js
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var formatter=function formatter(params){// Add your own title formatting logic here!
return params.defaultFormatter(params);};function ThemeProviderTitleFormatter(_ref){var children=_ref.children;return/*#__PURE__*/(0,jsx_runtime.jsx)(titleFormatterUtils/* TitleFormatterProvider */.AL,{formatter:formatter,children:children});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/ThemeProvider/index.js
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function ThemeProvider(_ref){var children=_ref.children;return/*#__PURE__*/(0,jsx_runtime.jsx)(ThemeProviderTitleFormatter,{children:children});}
...
function inertProps(inert){var isBeforeReact19=parseInt(react.version.split('.')[0],10)<19;if(isBeforeReact19){return{inert:inert?'':undefined};}return{inert:inert};}function NavbarMobileSidebarPanel(_ref){var children=_ref.children,inert=_ref.inert;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",Object.assign({className:(0,clsx/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.layout.navbar.mobileSidebar.panel,'navbar-sidebar__item menu')},inertProps(inert),{children:children}));}function NavbarMobileSidebarLayout(_ref2){var header=_ref2.header,primaryMenu=_ref2.primaryMenu,secondaryMenu=_ref2.secondaryMenu;var _useNavbarSecondaryMe=useNavbarSecondaryMenu(),secondaryMenuShown=_useNavbarSecondaryMe.shown;return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.layout.navbar.mobileSidebar.container,'navbar-sidebar'),children:[header,/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)('navbar-sidebar__items',{'navbar-sidebar__items--show-secondary':secondaryMenuShown}),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarMobileSidebarPanel,{inert:secondaryMenuShown,children:primaryMenu}),/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarMobileSidebarPanel,{inert:!secondaryMenuShown,children:secondaryMenu})]})]});}
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/contexts/colorMode.js
...
;// ./node_modules/@docusaurus/theme-classic/lib/theme/Icon/SystemColorMode/index.js
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function IconSystemColorMode(props){return/*#__PURE__*/(0,jsx_runtime.jsx)("svg",Object.assign({viewBox:"0 0 24 24",width:24,height:24},props,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("path",{fill:"currentColor",d:"m12 21c4.971 0 9-4.029 9-9s-4.029-9-9-9-9 4.029-9 9 4.029 9 9 9zm4.95-13.95c1.313 1.313 2.05 3.093 2.05 4.95s-0.738 3.637-2.05 4.95c-1.313 1.313-3.093 2.05-4.95 2.05v-14c1.857 0 3.637 0.737 4.95 2.05z"})}));}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/ColorModeToggle/styles.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const ColorModeToggle_styles_module = ({"toggle":"toggle_vylO","toggleButton":"toggleButton_gllP","toggleIcon":"toggleIcon_g3eP","systemToggleIcon":"systemToggleIcon_QzmC","lightToggleIcon":"lightToggleIcon_pyhR","darkToggleIcon":"darkToggleIcon_wfgR","toggleButtonDisabled":"toggleButtonDisabled_aARS"});
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function NavbarColorModeToggle(_ref){var className=_ref.className;var navbarStyle=(0,useThemeConfig/* useThemeConfig */.p)().navbar.style;var _useThemeConfig$color=(0,useThemeConfig/* useThemeConfig */.p)().colorMode,disableSwitch=_useThemeConfig$color.disableSwitch,respectPrefersColorScheme=_useThemeConfig$color.respectPrefersColorScheme;var _useColorMode=(0,colorMode/* useColorMode */.G)(),colorModeChoice=_useColorMode.colorModeChoice,setColorMode=_useColorMode.setColorMode;if(disableSwitch){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(theme_ColorModeToggle,{className:className,buttonClassName:navbarStyle==='dark'?Navbar_ColorModeToggle_styles_module.darkNavbarColorModeToggle:undefined,respectPrefersColorScheme:respectPrefersColorScheme,value:colorModeChoice,onChange:setColorMode});}
...
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DefaultNavbarItem/Mobile/index.js
var Mobile_excluded=["className","isDropdownItem"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DefaultNavbarItemMobile(_ref){var className=_ref.className,isDropdownItem=_ref.isDropdownItem,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Mobile_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:"menu__list-item",children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarNavLink,Object.assign({className:(0,clsx/* default */.A)('menu__link',className)},props))});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DefaultNavbarItem/Desktop/index.js
var Desktop_excluded=["className","isDropdownItem"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DefaultNavbarItemDesktop(_ref){var className=_ref.className,_ref$isDropdownItem=_ref.isDropdownItem,isDropdownItem=_ref$isDropdownItem===void 0?false:_ref$isDropdownItem,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Desktop_excluded);var element=/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarNavLink,Object.assign({className:(0,clsx/* default */.A)(isDropdownItem?'dropdown__link':'navbar__item navbar__link',className),isDropdownLink:isDropdownItem},props));if(isDropdownItem){return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{children:element});}return element;}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DefaultNavbarItem/index.js
var DefaultNavbarItem_excluded=["mobile","position"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DefaultNavbarItem(_ref){var _props$activeClassNam;var _ref$mobile=_ref.mobile,mobile=_ref$mobile===void 0?false:_ref$mobile,position=_ref.position,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,DefaultNavbarItem_excluded);var Comp=mobile?DefaultNavbarItemMobile:DefaultNavbarItemDesktop;return/*#__PURE__*/(0,jsx_runtime.jsx)(Comp,Object.assign({},props,{activeClassName:(_props$activeClassNam=props.activeClassName)!=null?_props$activeClassNam:mobile?'menu__link--active':'navbar__link--active'}));}
...
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DropdownNavbarItem/Mobile/styles.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const Mobile_styles_module = ({"dropdownNavbarItemMobile":"dropdownNavbarItemMobile_J0Sd"});
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DropdownNavbarItem/Mobile/index.js
var DropdownNavbarItem_Mobile_excluded=["items","className","position","onClick"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function isItemActive(item,localPathname){if((0,routesUtils/* isSamePath */.ys)(item.to,localPathname)){return true;}if(isRegexpStringMatch(item.activeBaseRegex,localPathname)){return true;}if(item.activeBasePath&&localPathname.startsWith(item.activeBasePath)){return true;}return false;}function containsActiveItems(items,localPathname){return items.some(function(item){return isItemActive(item,localPathname);});}function CollapseButton(_ref){var collapsed=_ref.collapsed,onClick=_ref.onClick;return/*#__PURE__*/(0,jsx_runtime.jsx)("button",{"aria-label":collapsed?(0,Translate/* translate */.T)({id:'theme.navbar.mobileDropdown.collapseButton.expandAriaLabel',message:'Expand the dropdown',description:'The ARIA label of the button to expand the mobile dropdown navbar item'}):(0,Translate/* translate */.T)({id:'theme.navbar.mobileDropdown.collapseButton.collapseAriaLabel',message:'Collapse the dropdown',description:'The ARIA label of the button to collapse the mobile dropdown navbar item'}),"aria-expanded":!collapsed,type:"button",className:"clean-btn menu__caret",onClick:onClick});}function useItemCollapsible(_ref2){var active=_ref2.active;var _useCollapsible=(0,Collapsible/* useCollapsible */.u)({initialState:function initialState(){return!active;}}),collapsed=_useCollapsible.collapsed,toggleCollapsed=_useCollapsible.toggleCollapsed,setCollapsed=_useCollapsible.setCollapsed;// Expand if any item active after a navigation
(0,react.useEffect)(function(){if(active){setCollapsed(false);}},[active,setCollapsed]);return{collapsed:collapsed,toggleCollapsed:toggleCollapsed};}function DropdownNavbarItemMobile(_ref3){var _props$children;var items=_ref3.items,className=_ref3.className,position=_ref3.position,onClick=_ref3.onClick,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref3,DropdownNavbarItem_Mobile_excluded);var localPathname=useLocalPathname();var isActive=(0,routesUtils/* isSamePath */.ys)(props.to,localPathname);var containsActive=containsActiveItems(items,localPathname);var _useItemCollapsible=useItemCollapsible({active:isActive||containsActive}),collapsed=_useItemCollapsible.collapsed,toggleCollapsed=_useItemCollapsible.toggleCollapsed;// # hash permits to make the <a> tag focusable in case no link target
// See https://github.com/facebook/docusaurus/pull/6003
// There's probably a better solution though...
var href=props.to?undefined:'#';return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",{className:(0,clsx/* default */.A)('menu__list-item',{'menu__list-item--collapsed':collapsed}),children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)('menu__list-item-collapsible',{'menu__list-item-collapsible--active':isActive}),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarNavLink,Object.assign({role:"button",className:(0,clsx/* default */.A)(Mobile_styles_module.dropdownNavbarItemMobile,'menu__link menu__link--sublist',className),href:href},props,{onClick:function onClick(e){// Prevent navigation when link is "#"
if(href==='#'){e.preventDefault();}// Otherwise we let navigation eventually happen, and/or collapse
toggleCollapsed();},children:(_props$children=props.children)!=null?_props$children:props.label})),/*#__PURE__*/(0,jsx_runtime.jsx)(CollapseButton,{collapsed:collapsed,onClick:function onClick(e){e.preventDefault();toggleCollapsed();}})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Collapsible/* Collapsible */.N,{lazy:true,as:"ul",className:"menu__list",collapsed:collapsed,children:items.map(function(childItemProps,i){return/*#__PURE__*/(0,react.createElement)(NavbarItem,Object.assign({mobile:true,isDropdownItem:true,onClick:onClick,activeClassName:"menu__link--active"},childItemProps,{key:i}));})})]});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DropdownNavbarItem/Desktop/index.js
var DropdownNavbarItem_Desktop_excluded=["items","position","className","onClick"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DropdownNavbarItemDesktop(_ref){var _props$children;var items=_ref.items,position=_ref.position,className=_ref.className,onClick=_ref.onClick,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,DropdownNavbarItem_Desktop_excluded);var dropdownRef=(0,react.useRef)(null);var _useState=(0,react.useState)(false),showDropdown=_useState[0],setShowDropdown=_useState[1];(0,react.useEffect)(function(){var handleClickOutside=function handleClickOutside(event){if(!dropdownRef.current||dropdownRef.current.contains(event.target)){return;}setShowDropdown(false);};document.addEventListener('mousedown',handleClickOutside);document.addEventListener('touchstart',handleClickOutside);document.addEventListener('focusin',handleClickOutside);return function(){document.removeEventListener('mousedown',handleClickOutside);document.removeEventListener('touchstart',handleClickOutside);document.removeEventListener('focusin',handleClickOutside);};},[dropdownRef]);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{ref:dropdownRef,className:(0,clsx/* default */.A)('navbar__item','dropdown','dropdown--hoverable',{'dropdown--right':position==='right','dropdown--show':showDropdown}),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarNavLink,Object.assign({"aria-haspopup":"true","aria-expanded":showDropdown,role:"button"// # hash permits to make the <a> tag focusable in case no link target
// See https://github.com/facebook/docusaurus/pull/6003
// There's probably a better solution though...
,href:props.to?undefined:'#',className:(0,clsx/* default */.A)('navbar__link',className)},props,{onClick:props.to?undefined:function(e){return e.preventDefault();},onKeyDown:function onKeyDown(e){if(e.key==='Enter'){e.preventDefault();setShowDropdown(!showDropdown);}},children:(_props$children=props.children)!=null?_props$children:props.label})),/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{className:"dropdown__menu",children:items.map(function(childItemProps,i){return/*#__PURE__*/(0,react.createElement)(NavbarItem,Object.assign({isDropdownItem:true,activeClassName:"dropdown__link--active"},childItemProps,{key:i}));})})]});}
;// ./node_modules/@docusaurus/theme-classic/lib/theme/NavbarItem/DropdownNavbarItem/index.js
var DropdownNavbarItem_excluded=["mobile"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DropdownNavbarItem(_ref){var _ref$mobile=_ref.mobile,mobile=_ref$mobile===void 0?false:_ref$mobile,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,DropdownNavbarItem_excluded);var Comp=mobile?DropdownNavbarItemMobile:DropdownNavbarItemDesktop;return/*#__PURE__*/(0,jsx_runtime.jsx)(Comp,Object.assign({},props));}
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/useAlternatePageUtils.js
var useAlternatePageUtils = __webpack_require__(2131);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function useLocaleDropdownUtils(){var _useDocusaurusContext=(0,useDocusaurusContext/* default */.A)(),siteConfig=_useDocusaurusContext.siteConfig,localeConfigs=_useDocusaurusContext.i18n.localeConfigs;var alternatePageUtils=(0,useAlternatePageUtils/* useAlternatePageUtils */.o)();var search=(0,historyUtils/* useHistorySelector */.Hl)(function(history){return history.location.search;});var hash=(0,historyUtils/* useHistorySelector */.Hl)(function(history){return history.location.hash;});var getLocaleConfig=function getLocaleConfig(locale){var localeConfig=localeConfigs[locale];if(!localeConfig){throw new Error("Docusaurus bug, no locale config found for locale="+locale);}return localeConfig;};var getBaseURLForLocale=function getBaseURLForLocale(locale){var localeConfig=getLocaleConfig(locale);var isSameDomain=localeConfig.url===siteConfig.url;if(isSameDomain){// Shorter paths if localized sites are hosted on the same domain
// This reduces HTML size a bit
return"pathname://"+alternatePageUtils.createUrl({locale:locale,fullyQualified:false});}return alternatePageUtils.createUrl({locale:locale,fullyQualified:true});};return{getURL:function getURL(locale,options){// We have 2 query strings because
...
var finalSearch=(0,historyUtils/* mergeSearchStrings */.jy)([search,options.queryString],'append');return""+getBaseURLForLocale(locale)+finalSearch+hash;},getLabel:function getLabel(locale){return getLocaleConfig(locale).label;},getLang:function getLang(locale){return getLocaleConfig(locale).htmlLang;}};}function LocaleDropdownNavbarItem(_ref){var mobile=_ref.mobile,dropdownItemsBefore=_ref.dropdownItemsBefore,dropdownItemsAfter=_ref.dropdownItemsAfter,queryString=_ref.queryString,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,LocaleDropdownNavbarItem_excluded);var utils=useLocaleDropdownUtils();var _useDocusaurusContext2=(0,useDocusaurusContext/* default */.A)(),_useDocusaurusContext3=_useDocusaurusContext2.i18n,currentLocale=_useDocusaurusContext3.currentLocale,locales=_useDocusaurusContext3.locales;var localeItems=locales.map(function(locale){return{label:utils.getLabel(locale),lang:utils.getLang(locale),to:utils.getURL(locale,{queryString:queryString}),target:'_self',autoAddBaseUrl:false,className:// eslint-disable-next-line no-nested-ternary
...
var dropdownLabel=mobile?(0,Translate/* translate */.T)({message:'Languages',id:'theme.navbar.mobileLanguageDropdown.label',description:'The label for the mobile language switcher dropdown'}):utils.getLabel(currentLocale);return/*#__PURE__*/(0,jsx_runtime.jsx)(DropdownNavbarItem,Object.assign({},props,{mobile:mobile,label:/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(IconLanguage,{className:LocaleDropdownNavbarItem_styles_module.iconLanguage}),dropdownLabel]}),items:items}));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function SearchNavbarItem(_ref){var mobile=_ref.mobile,className=_ref.className;if(mobile){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarSearch,{className:className,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Noop/* default */.A,{})});}
...
var DocsVersionDropdownNavbarItem_excluded=["mobile","docsPluginId","dropdownActiveClassDisabled","dropdownItemsBefore","dropdownItemsAfter","versions"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function getVersionItems(versions,configs){if(configs){// Collect all the versions we have
var versionMap=new Map(versions.map(function(version){return[version.name,version];}));var toVersionItem=function toVersionItem(name,config){var _config$label;var version=versionMap.get(name);if(!version){throw new Error("No docs version exist for name '"+name+"', please verify your 'docsVersionDropdown' navbar item versions config.\nAvailable version names:\n- "+versions.map(function(v){return""+v.name;}).join('\n- '));}return{version:version,label:(_config$label=config==null?void 0:config.label)!=null?_config$label:version.label};};if(Array.isArray(configs)){return configs.map(function(name){return toVersionItem(name,undefined);});}else{return Object.entries(configs).map(function(_ref){var name=_ref[0],config=_ref[1];return toVersionItem(name,config);});}}else{return versions.map(function(version){return{version:version,label:version.label};});}}function useVersionItems(_ref2){var docsPluginId=_ref2.docsPluginId,configs=_ref2.configs;var versions=(0,client/* useVersions */.jh)(docsPluginId);return getVersionItems(versions,configs);}function DocsVersionDropdownNavbarItem_getVersionMainDoc(version){return version.docs.find(function(doc){return doc.id===version.mainDocId;});}function getVersionTargetDoc(version,activeDocContext){var _activeDocContext$alt;// We try to link to the same doc, in another version
// When not possible, fallback to the "main doc" of the version
return(_activeDocContext$alt=activeDocContext.alternateDocVersions[version.name])!=null?_activeDocContext$alt:DocsVersionDropdownNavbarItem_getVersionMainDoc(version);}// The version item to use for the "dropdown button"
function useDisplayedVersionItem(_ref3){var _candidateItems$;var docsPluginId=_ref3.docsPluginId,versionItems=_ref3.versionItems;// The order of the candidates matters!
var candidates=(0,docsUtils/* useDocsVersionCandidates */.Vd)(docsPluginId);var candidateItems=candidates.map(function(candidate){return versionItems.find(function(vi){return vi.version===candidate;});}).filter(function(vi){return vi!==undefined;});return(_candidateItems$=candidateItems[0])!=null?_candidateItems$:versionItems[0];}function DocsVersionDropdownNavbarItem(_ref4){var mobile=_ref4.mobile,docsPluginId=_ref4.docsPluginId,dropdownActiveClassDisabled=_ref4.dropdownActiveClassDisabled,dropdownItemsBefore=_ref4.dropdownItemsBefore,dropdownItemsAfter=_ref4.dropdownItemsAfter,configs=_ref4.versions,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref4,DocsVersionDropdownNavbarItem_excluded);var search=(0,historyUtils/* useHistorySelector */.Hl)(function(history){return history.location.search;});var hash=(0,historyUtils/* useHistorySelector */.Hl)(function(history){return history.location.hash;});var activeDocContext=(0,client/* useActiveDocContext */.zK)(docsPluginId);var _useDocsPreferredVers=(0,docsPreferredVersion/* useDocsPreferredVersion */.g1)(docsPluginId),savePreferredVersionName=_useDocsPreferredVers.savePreferredVersionName;var versionItems=useVersionItems({docsPluginId:docsPluginId,configs:configs});var displayedVersionItem=useDisplayedVersionItem({docsPluginId:docsPluginId,versionItems:versionItems});function versionItemToLink(_ref5){var version=_ref5.version,label=_ref5.label;var targetDoc=getVersionTargetDoc(version,activeDocContext);return{label:label,// preserve ?search#hash suffix on version switches
to:""+targetDoc.path+search+hash,isActive:function isActive(){return version===activeDocContext.activeVersion;},onClick:function onClick(){return savePreferredVersionName(version.name);}};}var items=[].concat(dropdownItemsBefore,versionItems.map(versionItemToLink),dropdownItemsAfter);// Mobile dropdown is handled a bit differently
var dropdownLabel=mobile&&items.length>1?(0,Translate/* translate */.T)({id:'theme.navbar.mobileVersionsDropdown.label',message:'Versions',description:'The label for the navbar versions dropdown on mobile view'}):displayedVersionItem.label;var dropdownTo=mobile&&items.length>1?undefined:getVersionTargetDoc(displayedVersionItem.version,activeDocContext).path;// We don't want to render a version dropdown with 0 or 1 item. If we build
...
function ErrorBoundaryErrorMessageFallback(_ref){var error=_ref.error,tryAgain=_ref.tryAgain;return/*#__PURE__*/_jsxs("div",{className:styles.errorBoundaryFallback,children:[/*#__PURE__*/_jsx("p",{children:error.message}),/*#__PURE__*/_jsx(ErrorBoundaryTryAgainButton,{onClick:tryAgain})]});}function ErrorBoundaryError(_ref2){var error=_ref2.error;var causalChain=(0,lib/* getErrorCausalChain */.rA)(error);var fullMessage=causalChain.map(function(e){return e.message;}).join('\n\nCause:\n');return/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:errorBoundaryUtils_module.errorBoundaryError,children:fullMessage});}/**
...
return (0,useThemeConfig/* useThemeConfig */.p)().navbar.items;}function NavbarItems(_ref){var items=_ref.items;return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:items.map(function(item,i){return/*#__PURE__*/(0,jsx_runtime.jsx)(ErrorCauseBoundary,{onError:function onError(error){return new Error("A theme navbar item failed to render.\nPlease double-check the following navbar item (themeConfig.navbar.items) of your Docusaurus config:\n"+JSON.stringify(item,null,2),{cause:error});},children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarItem,Object.assign({},item))},i);})});}function NavbarContentLayout(_ref2){var left=_ref2.left,right=_ref2.right;return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"navbar__inner",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.layout.navbar.containerLeft,'navbar__items'),children:left}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.layout.navbar.containerRight,'navbar__items navbar__items--right'),children:right})]});}function NavbarContent(){var mobileSidebar=(0,navbarMobileSidebar/* useNavbarMobileSidebar */.M)();var items=Content_useNavbarItems();var _splitNavbarItems=splitNavbarItems(items),leftItems=_splitNavbarItems[0],rightItems=_splitNavbarItems[1];var searchBarItem=items.find(function(item){return item.type==='search';});return/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarContentLayout,{left:/*#__PURE__*/// TODO stop hardcoding items?
...
var LinkItem_excluded=["to","href","label","prependBaseUrlToHref","className"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function FooterLinkItem(_ref){var item=_ref.item;var to=item.to,href=item.href,label=item.label,prependBaseUrlToHref=item.prependBaseUrlToHref,className=item.className,props=(0,objectWithoutPropertiesLoose/* default */.A)(item,LinkItem_excluded);var toUrl=(0,useBaseUrl/* default */.Ay)(to);var normalizedHref=(0,useBaseUrl/* default */.Ay)(href,{forcePrependBaseUrl:true});return/*#__PURE__*/(0,jsx_runtime.jsxs)(Link/* default */.A,Object.assign({className:(0,clsx/* default */.A)('footer__link-item',className)},href?{href:prependBaseUrlToHref?normalizedHref:href}:{to:toUrl},props,{children:[label,href&&!(0,isInternalUrl/* default */.A)(href)&&/*#__PURE__*/(0,jsx_runtime.jsx)(ExternalLink/* default */.A,{})]}));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function ColumnLinkItem(_ref){var _item$href;var item=_ref.item;return item.html?/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:(0,clsx/* default */.A)('footer__item',item.className)// Developer provided the HTML, so assume it's safe.
// eslint-disable-next-line react/no-danger
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function Separator(){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:"footer__link-separator",children:"\xB7"});}function SimpleLinkItem(_ref){var item=_ref.item;return item.html?/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)('footer__link-item',item.className)// Developer provided the HTML, so assume it's safe.
// eslint-disable-next-line react/no-danger
...
/* harmony import */ var D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelperLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3845);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
function groupBy(items,keySelector){var result={};var index=0;for(var _iterator=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelperLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(items),_step;!(_step=_iterator()).done;){var _result$key;var item=_step.value;var key=keySelector(item,index);(_result$key=result[key])!=null?_result$key:result[key]=[];result[key].push(item);index+=1;}return result;}
...
/* harmony import */ var _utils_reactUtils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3807);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Context=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createContext(undefined);function useIsNavbarMobileSidebarDisabled(){var secondaryMenuContent=(0,_navbarSecondaryMenu_content__WEBPACK_IMPORTED_MODULE_1__/* .useNavbarSecondaryMenuContent */ .YL)();var items=(0,_utils_useThemeConfig__WEBPACK_IMPORTED_MODULE_4__/* .useThemeConfig */ .p)().navbar.items;return items.length===0&&!secondaryMenuContent.component;}function useContextValue(){var disabled=useIsNavbarMobileSidebarDisabled();var windowSize=(0,_hooks_useWindowSize__WEBPACK_IMPORTED_MODULE_2__/* .useWindowSize */ .l)();var shouldRender=!disabled&&windowSize==='mobile';var _useState=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),shown=_useState[0],setShown=_useState[1];var toggle=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function(){setShown(function(s){return!s;});},[]);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){if(windowSize==='desktop'){setShown(false);}},[windowSize]);return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function(){return{disabled:disabled,shouldRender:shouldRender,toggle:toggle,shown:shown};},[disabled,shouldRender,toggle,shown]);}// A component hook wrapper enables conditional rendering
// See reason here: https://github.com/facebook/docusaurus/issues/10988
function OnHistoryPop(_ref){var handler=_ref.handler;(0,_utils_historyUtils__WEBPACK_IMPORTED_MODULE_3__/* .useHistoryPopHandler */ .$Z)(handler);return null;}function NavbarMobileSidebarProvider(_ref2){var children=_ref2.children;var value=useContextValue();return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment,{children:[// Close mobile sidebar on navigation pop
...
value.shown&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(OnHistoryPop,{handler:function handler(){value.toggle();// Prevent pop navigation; seems desirable enough
 ...
 *
 * @see https://developers.google.com/search/docs/advanced/crawling/localized-versions
 */function useAlternatePageUtils(){var _useDocusaurusContext=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(),_useDocusaurusContext2=_useDocusaurusContext.siteConfig,baseUrl=_useDocusaurusContext2.baseUrl,trailingSlash=_useDocusaurusContext2.trailingSlash,localeConfigs=_useDocusaurusContext.i18n.localeConfigs;// TODO using useLocation().pathname is not a super idea
// See https://github.com/facebook/docusaurus/issues/9170
var _useLocation=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useLocation */ .zy)(),pathname=_useLocation.pathname;var canonicalPathname=(0,_docusaurus_utils_common__WEBPACK_IMPORTED_MODULE_2__/* .applyTrailingSlash */ .Ks)(pathname,{trailingSlash:trailingSlash,baseUrl:baseUrl});// Canonical pathname, without the baseUrl of the current locale
var pathnameSuffix=canonicalPathname.replace(baseUrl,'');function getLocaleConfig(locale){var localeConfig=localeConfigs[locale];if(!localeConfig){throw new Error("Unexpected Docusaurus bug, no locale config found for locale="+locale);}return localeConfig;}function createUrl(_ref){var locale=_ref.locale,fullyQualified=_ref.fullyQualified;var localeConfig=getLocaleConfig(locale);var newUrl=""+(fullyQualified?localeConfig.url:'');var newBaseUrl=localeConfig.baseUrl;return""+newUrl+newBaseUrl+pathnameSuffix;}return{createUrl:createUrl};}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */Object.defineProperty(exports, "__esModule", ({value:true}));exports.addTrailingSlash=addTrailingSlash;exports["default"]=applyTrailingSlash;exports.addLeadingSlash=addLeadingSlash;exports.removeTrailingSlash=removeTrailingSlash;var stringUtils_1=__webpack_require__(2566);function addTrailingSlash(str){return str.endsWith('/')?str:str+"/";}// Trailing slash handling depends in some site configuration options
 ...
 */function DocsVersionProvider(_ref){var children=_ref.children,version=_ref.version;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(Context.Provider,{value:version,children:children});}/**
 * Gets the version metadata of the current doc page.
 */function useDocsVersion(){var version=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(version===null){throw new _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_1__/* .ReactContextError */ .dV('DocsVersionProvider');}return version;}
...
/* harmony import */ var _reactUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3807);
 ...
 */function useScrollController(){var context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(ScrollMonitorContext);if(context==null){throw new _reactUtils__WEBPACK_IMPORTED_MODULE_4__/* .ReactContextError */ .dV('ScrollControllerProvider');}return context;}var getScrollPosition=function getScrollPosition(){return _docusaurus_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.canUseDOM?{scrollX:window.pageXOffset,scrollY:window.pageYOffset}:null;};/**
 ...
 */function useScrollPosition(effect,deps){if(deps===void 0){deps=[];}var _useScrollController=useScrollController(),scrollEventsEnabledRef=_useScrollController.scrollEventsEnabledRef;var lastPositionRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(getScrollPosition());var dynamicEffect=(0,_reactUtils__WEBPACK_IMPORTED_MODULE_4__/* .useEvent */ ._q)(effect);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){var handleScroll=function handleScroll(){if(!scrollEventsEnabledRef.current){return;}var currentPosition=getScrollPosition();dynamicEffect(currentPosition,lastPositionRef.current);lastPositionRef.current=currentPosition;};var opts={passive:true};handleScroll();window.addEventListener('scroll',handleScroll,opts);return function(){return window.removeEventListener('scroll',handleScroll,opts);};// eslint-disable-next-line react-compiler/react-compiler
...
var svgSprite='#theme-svg-external-link';function IconExternalLink(_ref){var _ref$width=_ref.width,width=_ref$width===void 0?13.5:_ref$width,_ref$height=_ref.height,height=_ref$height===void 0?13.5:_ref$height;return/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{width:width,height:height,"aria-label":(0,Translate/* translate */.T)({id:'theme.IconExternalLink.ariaLabel',message:'(opens in new tab)',description:'The ARIA label for the external link icon'}),className:styles_module.iconExternalLink,children:/*#__PURE__*/(0,jsx_runtime.jsx)("use",{href:svgSprite})});}
...
/* harmony import */ var _theme_ThemedImage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1122);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function LogoThemedImage(_ref){var logo=_ref.logo,alt=_ref.alt,imageClassName=_ref.imageClassName;var sources={light:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Ay)(logo.src),dark:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Ay)(logo.srcDark||logo.src)};var themedImage=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_theme_ThemedImage__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A,{className:logo.className,sources:sources,height:logo.height,width:logo.width,alt:alt,style:logo.style});// Is this extra div really necessary?
// introduced in https://github.com/facebook/docusaurus/pull/5666
return imageClassName?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div",{className:imageClassName,children:themedImage}):themedImage;}function Logo(props){var _logo$alt;var _useDocusaurusContext=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A)(),title=_useDocusaurusContext.siteConfig.title;var _useThemeConfig=(0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_5__/* .useThemeConfig */ .p)(),_useThemeConfig$navba=_useThemeConfig.navbar,navbarTitle=_useThemeConfig$navba.title,logo=_useThemeConfig$navba.logo;var imageClassName=props.imageClassName,titleClassName=props.titleClassName,propsRest=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(props,_excluded);var logoLink=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Ay)((logo==null?void 0:logo.href)||'/');// If visible title is shown, fallback alt text should be
// an empty string to mark the logo as decorative.
var fallbackAlt=navbarTitle?'':title;// Use logo alt text if provided (including empty string),
// and provide a sensible fallback otherwise.
var alt=(_logo$alt=logo==null?void 0:logo.alt)!=null?_logo$alt:fallbackAlt;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,Object.assign({to:logoLink},propsRest,(logo==null?void 0:logo.target)&&{target:logo.target},{children:[logo&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(LogoThemedImage,{logo:logo,alt:alt,imageClassName:imageClassName}),navbarTitle!=null&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("b",{className:titleClassName,children:navbarTitle})]}));}
...
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-common/lib/utils/useThemeConfig.js
var useThemeConfig = __webpack_require__(6342);
;// ./node_modules/@docusaurus/theme-common/lib/utils/anchorUtils.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const anchorUtils_module = ({"anchorTargetStickyNavbar":"anchorTargetStickyNavbar_Vzrq","anchorTargetHideOnScrollNavbar":"anchorTargetHideOnScrollNavbar_vjPI"});
;// ./node_modules/@docusaurus/theme-common/lib/utils/anchorUtils.js
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 ...
 */function useAnchorTargetClassName(id){var _useThemeConfig=(0,useThemeConfig/* useThemeConfig */.p)(),hideOnScroll=_useThemeConfig.navbar.hideOnScroll;if(typeof id==='undefined'){return undefined;}return hideOnScroll?anchorUtils_module.anchorTargetHideOnScrollNavbar:anchorUtils_module.anchorTargetStickyNavbar;}
 ...
 */function usePrevious(value){var ref=(0,react.useRef)();(0,useIsomorphicLayoutEffect/* default */.A)(function(){ref.current=value;});// TODO need to fix this React Compiler lint error
...
deps.sort(function(a,b){return a[0].localeCompare(b[0]);});// eslint-disable-next-line react-compiler/react-compiler,react-hooks/exhaustive-deps
...
/* harmony import */ var _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(679);
/* harmony import */ var _docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3807);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4848);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var storageKey=function storageKey(pluginId){return"docs-preferred-version-"+pluginId;};var DocsPreferredVersionStorage={save:function save(pluginId,persistence,versionName){(0,_docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_4__/* .createStorageSlot */ .Wf)(storageKey(pluginId),{persistence:persistence}).set(versionName);},read:function read(pluginId,persistence){return (0,_docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_4__/* .createStorageSlot */ .Wf)(storageKey(pluginId),{persistence:persistence}).get();},clear:function clear(pluginId,persistence){(0,_docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_4__/* .createStorageSlot */ .Wf)(storageKey(pluginId),{persistence:persistence}).del();}};/**
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"/blog-b2f":{"__comp":"a6aa9e1f","__context":{"plugin":"36994c47"},"sidebar":"814f3328","items":[{"content":"7661071f"},{"content":"f4f34a3a"},{"content":"8717b14a"},{"content":"925b3f96"}],"__props":"c15d9823"},"/blog/archive-182":{"__comp":"9e4087bc","__context":{"plugin":"36994c47"},"__props":"f81c1134"},"/blog/authors-0b7":{"__comp":"621db11d","__context":{"data":{"blogMetadata":"acecf23e"},"plugin":"36994c47"},"sidebar":"814f3328","__props":"ef8b811a"},"/blog/authors/all-sebastien-lorber-articles-4a1":{"__comp":"33fc5bb8","__context":{"data":{"blogMetadata":"acecf23e"},"plugin":"36994c47"},"items":[{"content":"7661071f"},{"content":"f4f34a3a"},{"content":"925b3f96"}],"sidebar":"814f3328","__props":"c9c9bef8"},"/blog/authors/yangshun-a68":{"__comp":"33fc5bb8","__context":{"data":{"blogMetadata":"acecf23e"},"plugin":"36994c47"},"items":[{"content":"7661071f"},{"content":"8717b14a"},{"content":"925b3f96"}],"sidebar":"814f3328","__props":"1dea6ca3"},"/blog/first-blog-post-89a":{"__comp":"ccc49370","__context":{"data":{"blogMetadata":"acecf23e"},"plugin":"36994c47"},"sidebar":"814f3328","content":"e273c56f"},"/blog/long-blog-post-9ad":{"__comp":"ccc49370","__context":{"data":{"blogMetadata":"acecf23e"},"plugin":"36994c47"},"sidebar":"814f3328","content":"73664a40"},"/blog/mdx-blog-post-e9f":{"__comp":"ccc49370","__context":{"data":{"blogMetadata":"acecf23e"},"plugin":"36994c47"},"sidebar":"814f3328","content":"59362658"},"/blog/tags-287":{"__comp":"01a85c17","__context":{"plugin":"36994c47"},"sidebar":"814f3328","__props":"3a2db09e"},"/blog/tags/docusaurus-704":{"__comp":"6875c492","__context":{"plugin":"36994c47"},"sidebar":"814f3328","items":[{"content":"7661071f"},{"content":"f4f34a3a"},{"content":"8717b14a"},{"content":"925b3f96"}],"__props":"3217192f"},"/blog/tags/facebook-858":{"__comp":"6875c492","__context":{"plugin":"36994c47"},"sidebar":"814f3328","items":[{"content":"7661071f"}],"__props":"e5aefb32"},"/blog/tags/hello-299":{"__comp":"6875c492","__context":{"plugin":"36994c47"},"sidebar":"814f3328","items":[{"content":"7661071f"},{"content":"8717b14a"}],"__props":"f82cd581"},"/blog/tags/hola-00d":{"__comp":"6875c492","__context":{"plugin":"36994c47"},"sidebar":"814f3328","items":[{"content":"925b3f96"}],"__props":"5e90a9b3"},"/blog/welcome-d2b":{"__comp":"ccc49370","__context":{"data":{"blogMetadata":"acecf23e"},"plugin":"36994c47"},"sidebar":"814f3328","content":"d9f32620"},"/course-modules-672":{"__comp":"b4332287","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"},"/forgot-761":{"__comp":"ef42623e","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"},"/markdown-page-3d7":{"__comp":"1f391b9e","__context":{"plugin":"a7456010"},"content":"393be207"},"/signin-ba0":{"__comp":"6f7d680a","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"},"/signup-312":{"__comp":"8d9bf57a","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"},"/docs-c95":{"__comp":"5e95c892","__context":{"plugin":"aba21aa0"}},"/docs-002":{"__comp":"a7bd4aaa","__props":"0058b4c6"},"/docs-d45":{"__comp":"a94703ab"},"/docs/intro-61d":{"__comp":"17896441","content":"0e384e19"},"/docs/Module 5-Physical AI/week18-physical-ai-foundations-339":{"__comp":"17896441","content":"d98bd9ec"},"/docs/Module 5-Physical AI/week19-perception-action-loops-f13":{"__comp":"17896441","content":"cac0a167"},"/docs/Module 5-Physical AI/week20-real-environment-intelligence-981":{"__comp":"17896441","content":"180f194e"},"/docs/module-1-ros2/week1-introduction-d94":{"__comp":"17896441","content":"3adc2175"},"/docs/module-1-ros2/week2-physical-ai-landscape-992":{"__comp":"17896441","content":"7ffc8b6c"},"/docs/module-1-ros2/week3-ros2-architecture-nodes-dd3":{"__comp":"17896441","content":"be981d16"},"/docs/module-1-ros2/week4-ros2-topics-services-ecb":{"__comp":"17896441","content":"218c9838"},"/docs/module-1-ros2/week5-ros2-advanced-patterns-0d9":{"__comp":"17896441","content":"db2345f2"},"/docs/module-2-gazebo/week6-simulation-concepts-2fd":{"__comp":"17896441","content":"7b36d7d3"},"/docs/module-2-gazebo/week7-robot-modeling-urdf-bd4":{"__comp":"17896441","content":"522c9417"},"/docs/module-2-gazebo/week8-gazebo-sensors-9cd":{"__comp":"17896441","content":"5c071cef"},"/docs/module-2-gazebo/week9-gazebo-controllers-1a4":{"__comp":"17896441","content":"fb4678e3"},"/docs/module-3-nvidia-isaac/week10-intro-isaac-sim-6bd":{"__comp":"17896441","content":"51423826"},"/docs/module-3-nvidia-isaac/week11-isaac-pipeline-usd-b06":{"__comp":"17896441","content":"fa4cad99"},"/docs/module-3-nvidia-isaac/week12-isaac-perception-sensors-2fd":{"__comp":"17896441","content":"92b35afe"},"/docs/module-3-nvidia-isaac/week13-isaac-robotics-ai-d40":{"__comp":"17896441","content":"46fab1df"},"/docs/module-4-humanoids/week14-humanoid-foundations-ea4":{"__comp":"17896441","content":"c33a7516"},"/docs/module-4-humanoids/week15-biped-locomotion-504":{"__comp":"17896441","content":"3dd47ec8"},"/docs/module-4-humanoids/week16-humanoid-manipulation-2d2":{"__comp":"17896441","content":"20482497"},"/docs/module-4-humanoids/week17-humanoid-vision-learning-7af":{"__comp":"17896441","content":"abd54b78"},"/docs/tutorial-basics/congratulations-70e":{"__comp":"17896441","content":"822bd8ab"},"/docs/tutorial-basics/create-a-blog-post-315":{"__comp":"17896441","content":"533a09ca"},"/docs/tutorial-basics/create-a-document-f86":{"__comp":"17896441","content":"1e4232ab"},"/docs/tutorial-basics/create-a-page-9f6":{"__comp":"17896441","content":"5c868d36"},"/docs/tutorial-basics/deploy-your-site-b91":{"__comp":"17896441","content":"f55d3e7a"},"/docs/tutorial-basics/markdown-features-272":{"__comp":"17896441","content":"18c41134"},"/docs/tutorial-extras/manage-docs-versions-a34":{"__comp":"17896441","content":"dff1c289"},"/docs/tutorial-extras/translate-your-site-739":{"__comp":"17896441","content":"e44a2883"},"/-e5f":{"__comp":"1df93b7f","__context":{"plugin":"a7456010"},"config":"5e9f5e1a"}}');
...
/* harmony import */ var _reactUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3807);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4848);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var TitleFormatterFnDefault=function TitleFormatterFnDefault(_ref){var title=_ref.title,siteTitle=_ref.siteTitle,titleDelimiter=_ref.titleDelimiter;var trimmedTitle=title==null?void 0:title.trim();if(!trimmedTitle||trimmedTitle===siteTitle){return siteTitle;}return trimmedTitle+" "+titleDelimiter+" "+siteTitle;};var TitleFormatterContext=/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(null);function TitleFormatterProvider(_ref2){var formatter=_ref2.formatter,children=_ref2.children;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(TitleFormatterContext.Provider,{value:formatter,children:children});}function useTitleFormatterContext(){var value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(TitleFormatterContext);if(value===null){throw new _reactUtils__WEBPACK_IMPORTED_MODULE_3__/* .ReactContextError */ .dV('TitleFormatterProvider');}return value;}/**
 * Returns a function to format the page title
 */function useTitleFormatter(){var formatter=useTitleFormatterContext();var _useDocusaurusContext=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(),siteConfig=_useDocusaurusContext.siteConfig;var siteTitle=siteConfig.title,titleDelimiter=siteConfig.titleDelimiter;// Unfortunately we can only call this hook here, not in the provider
// Route context can't be accessed in any provider applied above the router
var _useRouteContext=(0,_docusaurus_useRouteContext__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(),plugin=_useRouteContext.plugin;return{format:function format(title){return formatter({title:title,siteTitle:siteTitle,titleDelimiter:titleDelimiter,plugin:plugin,defaultFormatter:TitleFormatterFnDefault});}};}
...
/* harmony import */ var _utils_reactUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3807);
/* harmony import */ var _utils_useThemeConfig__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6342);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4848);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
/* harmony import */ var _docusaurus_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6347);
/* harmony import */ var _reactUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3807);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
/* harmony import */ var _docusaurus_useIsBrowser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2303);
/* harmony import */ var _utils_reactUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3807);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function getSystemColorMode(){return window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';}function subscribeToMedia(query,listener){var mql=window.matchMedia(query);mql.addEventListener('change',listener);return function(){return mql.removeEventListener('change',listener);};}function subscribeToSystemColorModeChange(onChange){return subscribeToMedia('(prefers-color-scheme: dark)',function(){return onChange(getSystemColorMode());});}var Context=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createContext(undefined);var ColorModeStorageKey='theme';var ColorModeStorage=(0,_utils_storageUtils__WEBPACK_IMPORTED_MODULE_3__/* .createStorageSlot */ .Wf)(ColorModeStorageKey);// We use data-theme-choice="system", not an absent attribute
// This is easier to handle for users with CSS
var SystemAttribute='system';// Ensure to always return a valid colorMode even if input is invalid
var coerceToColorMode=function coerceToColorMode(colorMode){return colorMode==='dark'?'dark':'light';};var coerceToColorModeChoice=function coerceToColorModeChoice(colorMode){return colorMode===null||colorMode===SystemAttribute?null:coerceToColorMode(colorMode);};var ColorModeAttribute={get:function get(){return coerceToColorMode(document.documentElement.getAttribute('data-theme'));},set:function set(colorMode){document.documentElement.setAttribute('data-theme',coerceToColorMode(colorMode));}};var ColorModeChoiceAttribute={get:function get(){return coerceToColorModeChoice(document.documentElement.getAttribute('data-theme-choice'));},set:function set(colorMode){var _coerceToColorModeCho;document.documentElement.setAttribute('data-theme-choice',(_coerceToColorModeCho=coerceToColorModeChoice(colorMode))!=null?_coerceToColorModeCho:SystemAttribute);}};var persistColorModeChoice=function persistColorModeChoice(newColorMode){if(newColorMode===null){ColorModeStorage.del();}else{ColorModeStorage.set(coerceToColorMode(newColorMode));}};// The color mode state is initialized in useEffect on purpose
...
function useColorModeState(){var _useThemeConfig=(0,_utils_useThemeConfig__WEBPACK_IMPORTED_MODULE_4__/* .useThemeConfig */ .p)(),defaultMode=_useThemeConfig.colorMode.defaultMode;var isBrowser=(0,_docusaurus_useIsBrowser__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)();// Since the provider may unmount/remount on client navigation, we need to
...
var _useState=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(isBrowser?ColorModeAttribute.get():defaultMode),colorMode=_useState[0],setColorModeState=_useState[1];var _useState2=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(isBrowser?ColorModeChoiceAttribute.get():null),colorModeChoice=_useState2[0],setColorModeChoiceState=_useState2[1];(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){setColorModeState(ColorModeAttribute.get());setColorModeChoiceState(ColorModeChoiceAttribute.get());},[]);return{colorMode:colorMode,setColorModeState:setColorModeState,colorModeChoice:colorModeChoice,setColorModeChoiceState:setColorModeChoiceState};}function useContextValue(){var _useThemeConfig2=(0,_utils_useThemeConfig__WEBPACK_IMPORTED_MODULE_4__/* .useThemeConfig */ .p)(),_useThemeConfig2$colo=_useThemeConfig2.colorMode,defaultMode=_useThemeConfig2$colo.defaultMode,disableSwitch=_useThemeConfig2$colo.disableSwitch,respectPrefersColorScheme=_useThemeConfig2$colo.respectPrefersColorScheme;var _useColorModeState=useColorModeState(),colorMode=_useColorModeState.colorMode,setColorModeState=_useColorModeState.setColorModeState,colorModeChoice=_useColorModeState.colorModeChoice,setColorModeChoiceState=_useColorModeState.setColorModeChoiceState;(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){// A site is deployed without disableSwitch
...
if(disableSwitch){ColorModeStorage.del();}},[disableSwitch]);var setColorMode=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function(newColorModeChoice,options){if(options===void 0){options={};}var _options=options,_options$persist=_options.persist,persist=_options$persist===void 0?true:_options$persist;// Reset to system/default color mode
if(newColorModeChoice===null){// Set the effective color
var newColorMode=respectPrefersColorScheme?getSystemColorMode():defaultMode;ColorModeAttribute.set(newColorMode);setColorModeState(newColorMode);// Set the chosen color
...
(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){return ColorModeStorage.listen(function(e){setColorMode(coerceToColorModeChoice(e.newValue));});},[setColorMode]);// Synchronize theme color with system color
(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){if(colorModeChoice!==null||!respectPrefersColorScheme){return undefined;}return subscribeToSystemColorModeChange(function(newSystemColorMode){// Note: we don't use "setColorMode" on purpose
...
setColorModeState(newSystemColorMode);ColorModeAttribute.set(newSystemColorMode);});},[respectPrefersColorScheme,colorModeChoice,setColorModeState]);return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function(){return{colorMode:colorMode,colorModeChoice:colorModeChoice,setColorMode:setColorMode,get isDarkTheme(){if(false)// removed by dead control flow
{}return colorMode==='dark';},setLightTheme:function setLightTheme(){if(false)// removed by dead control flow
{}setColorMode('light');},setDarkTheme:function setDarkTheme(){if(false)// removed by dead control flow
{}setColorMode('dark');}};},[colorMode,colorModeChoice,setColorMode]);}function ColorModeProvider(_ref){var children=_ref.children;var value=useContextValue();return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Context.Provider,{value:value,children:children});}function useColorMode(){var context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(context==null){throw new _utils_reactUtils__WEBPACK_IMPORTED_MODULE_2__/* .ReactContextError */ .dV('ColorModeProvider','Please see https://docusaurus.io/docs/api/themes/configuration#use-color-mode.');}return context;}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function TitleMetadata(_ref){var title=_ref.title;var titleFormatter=(0,_titleFormatterUtils__WEBPACK_IMPORTED_MODULE_5__/* .useTitleFormatter */ .s$)();var formattedTitle=titleFormatter.format(title);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("title",{children:formattedTitle}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("meta",{property:"og:title",content:formattedTitle})]});}function DescriptionMetadata(_ref2){var description=_ref2.description;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("meta",{name:"description",content:description}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("meta",{property:"og:description",content:description})]});}function ImageMetadata(_ref3){var image=_ref3.image;var _useBaseUrlUtils=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_4__/* .useBaseUrlUtils */ .hH)(),withBaseUrl=_useBaseUrlUtils.withBaseUrl;var pageImage=withBaseUrl(image,{absolute:true});return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("meta",{property:"og:image",content:pageImage}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("meta",{name:"twitter:image",content:pageImage})]});}function KeywordsMetadata(_ref4){var keywords=_ref4.keywords;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("meta",{name:"keywords",content:// https://github.com/microsoft/TypeScript/issues/17002
Array.isArray(keywords)?keywords.join(','):keywords})});}/**
 * Helper component to manipulate page metadata and override site defaults.
 * Works in the same way as Helmet.
 */function PageMetadata(_ref5){var title=_ref5.title,description=_ref5.description,keywords=_ref5.keywords,image=_ref5.image,children=_ref5.children;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment,{children:[title&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(TitleMetadata,{title:title}),description&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(DescriptionMetadata,{description:description}),keywords&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(KeywordsMetadata,{keywords:keywords}),image&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(ImageMetadata,{image:image}),children&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{children:children})]});}var HtmlClassNameContext=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createContext(undefined);/**
 ...
 */function HtmlClassNameProvider(_ref6){var classNameProp=_ref6.className,children=_ref6.children;var classNameContext=react__WEBPACK_IMPORTED_MODULE_0__.useContext(HtmlClassNameContext);var className=(0,clsx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(classNameContext,classNameProp);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(HtmlClassNameContext.Provider,{value:className,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("html",{className:className})}),children]});}function pluginNameToClassName(pluginName){return"plugin-"+pluginName.replace(/docusaurus-(?:plugin|theme)-(?:content-)?/gi,'');}/**
 * A very thin wrapper around `HtmlClassNameProvider` that adds the plugin ID +
 * name to the HTML class name.
 */function PluginHtmlClassNameProvider(_ref7){var children=_ref7.children;var routeContext=(0,_docusaurus_useRouteContext__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)();var nameClass=pluginNameToClassName(routeContext.plugin.name);var idClass="plugin-id-"+routeContext.plugin.id;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(HtmlClassNameProvider,{className:(0,clsx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(nameClass,idClass),children:children});}
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
/* harmony import */ var _utils_reactUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3807);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4848);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
...
(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(Context.Provider,{value:value,children:children}));}/** @internal */function useNavbarSecondaryMenuContent(){var value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(!value){throw new _utils_reactUtils__WEBPACK_IMPORTED_MODULE_1__/* .ReactContextError */ .dV('NavbarSecondaryMenuContentProvider');}return value[0];}/**
 ...
 */function NavbarSecondaryMenuFiller(_ref2){var component=_ref2.component,props=_ref2.props;var context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Context);if(!context){throw new _utils_reactUtils__WEBPACK_IMPORTED_MODULE_1__/* .ReactContextError */ .dV('NavbarSecondaryMenuContentProvider');}var setContent=context[1];// To avoid useless context re-renders, props are memoized shallowly
var memoizedProps=(0,_utils_reactUtils__WEBPACK_IMPORTED_MODULE_1__/* .useShallowMemoObject */ .Be)(props);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function(){// @ts-expect-error: this context is hard to type
...
__webpack_require__(8692)("./prism-"+lang);});// Clean up and eventually restore former globalThis.Prism object (if any)
...
/* harmony import */ var _docusaurus_renderRoutes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2831);
...
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1682);
/* harmony import */ var _docsPreferredVersion__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3886);
/* harmony import */ var _docsVersion__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(3025);
/* harmony import */ var _docsSidebar__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(609);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function useDocById(id){var version=useDocsVersion();if(!id){return undefined;}var doc=version.docs[id];if(!doc){throw new Error("no version doc found by id="+id);}return doc;}/**
 ...
 * Gets the category associated with the current location. Should only be used
 * on category index pages.
 */function useCurrentSidebarSiblings(){var _deepestCategory$item;var _useLocation2=useLocation(),pathname=_useLocation2.pathname;var sidebar=useDocsSidebar();if(!sidebar){throw new Error('Unexpected: cant find current sidebar in context');}var categoryBreadcrumbs=getSidebarBreadcrumbs({sidebarItems:sidebar.items,pathname:pathname,onlyCategories:true});var deepestCategory=categoryBreadcrumbs.slice(-1)[0];return(_deepestCategory$item=deepestCategory==null?void 0:deepestCategory.items)!=null?_deepestCategory$item:sidebar.items;}var isActive=function isActive(testedPath,activePath){return typeof testedPath!=='undefined'&&(0,_docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_5__/* .isSamePath */ .ys)(testedPath,activePath);};var containsActiveSidebarItem=function containsActiveSidebarItem(items,activePath){return items.some(function(subItem){return isActiveSidebarItem(subItem,activePath);});};/**
 * Checks if a sidebar item should be active, based on the active path.
 */function isActiveSidebarItem(item,activePath){if(item.type==='link'){return isActive(item.href,activePath);}if(item.type==='category'){return isActive(item.href,activePath)||containsActiveSidebarItem(item.items,activePath);}return false;}function isVisibleSidebarItem(item,activePath){switch(item.type){case'category':return isActiveSidebarItem(item,activePath)||typeof item.href!=='undefined'&&!item.linkUnlisted||item.items.some(function(subItem){return isVisibleSidebarItem(subItem,activePath);});case'link':// An unlisted item remains visible if it is active
return!item.unlisted||isActiveSidebarItem(item,activePath);default:return true;}}function useVisibleSidebarItems(items,activePath){return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function(){return items.filter(function(item){return isVisibleSidebarItem(item,activePath);});},[items,activePath]);}/**
 * Get the sidebar the breadcrumbs for a given pathname
 * Ordered from top to bottom
 */function getSidebarBreadcrumbs(_ref){var sidebarItems=_ref.sidebarItems,pathname=_ref.pathname,_ref$onlyCategories=_ref.onlyCategories,onlyCategories=_ref$onlyCategories===void 0?false:_ref$onlyCategories;var breadcrumbs=[];function extract(items){for(var _iterator3=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelperLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(items),_step3;!(_step3=_iterator3()).done;){var item=_step3.value;if(item.type==='category'&&((0,_docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_5__/* .isSamePath */ .ys)(item.href,pathname)||extract(item.items))||item.type==='link'&&(0,_docusaurus_theme_common_internal__WEBPACK_IMPORTED_MODULE_5__/* .isSamePath */ .ys)(item.href,pathname)){var filtered=onlyCategories&&item.type!=='category';if(!filtered){breadcrumbs.unshift(item);}return true;}}return false;}extract(sidebarItems);return breadcrumbs;}/**
 * Gets the breadcrumbs of the current doc page, based on its sidebar location.
 * Returns `null` if there's no sidebar or breadcrumbs are disabled.
 */function useSidebarBreadcrumbs(){var _useActivePlugin;var sidebar=(0,_docsSidebar__WEBPACK_IMPORTED_MODULE_9__/* .useDocsSidebar */ .t)();var _useLocation3=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_2__/* .useLocation */ .zy)(),pathname=_useLocation3.pathname;var breadcrumbsOption=(_useActivePlugin=(0,_docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_4__/* .useActivePlugin */ .vT)())==null?void 0:_useActivePlugin.pluginData.breadcrumbs;if(breadcrumbsOption===false||!sidebar){return null;}return getSidebarBreadcrumbs({sidebarItems:sidebar.items,pathname:pathname});}/**
 ...
 */function useDocsVersionCandidates(docsPluginId){var _useActiveDocContext=(0,_docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_4__/* .useActiveDocContext */ .zK)(docsPluginId),activeVersion=_useActiveDocContext.activeVersion;var _useDocsPreferredVers=(0,_docsPreferredVersion__WEBPACK_IMPORTED_MODULE_7__/* .useDocsPreferredVersion */ .g1)(docsPluginId),preferredVersion=_useDocsPreferredVers.preferredVersion;var latestVersion=(0,_docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_4__/* .useLatestVersion */ .r7)(docsPluginId);return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function(){return (0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_6__/* .uniq */ .sb)([activeVersion,preferredVersion,latestVersion].filter(Boolean));},[activeVersion,preferredVersion,latestVersion]);}/**
 ...
 */function useLayoutDoc(docId,docsPluginId){var versions=useDocsVersionCandidates(docsPluginId);return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function(){var allDocs=versions.flatMap(function(version){return version.docs;});var doc=allDocs.find(function(versionDoc){return versionDoc.id===docId;});if(!doc){var isDraft=versions.flatMap(function(version){return version.draftIds;}).includes(docId);// Drafts should be silently filtered instead of throwing
if(isDraft){return null;}throw new Error("Couldn't find any doc with id \""+docId+"\" in version"+(versions.length>1?'s':'')+" \""+versions.map(function(version){return version.name;}).join(', ')+"\".\nAvailable doc ids are:\n- "+(0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_6__/* .uniq */ .sb)(allDocs.map(function(versionDoc){return versionDoc.id;})).join('\n- '));}return doc;},[docId,versions]);}// TODO later read version/route directly from context
/**
 ...
 */function useDocRootMetadata(_ref2){var route=_ref2.route;var location=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_2__/* .useLocation */ .zy)();var versionMetadata=(0,_docsVersion__WEBPACK_IMPORTED_MODULE_8__/* .useDocsVersion */ .r)();var docRoutes=route.routes;var currentDocRoute=docRoutes.find(function(docRoute){return (0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_2__/* .matchPath */ .B6)(location.pathname,docRoute);});if(!currentDocRoute){return null;}// For now, the sidebarName is added as route config: not ideal!
var sidebarName=currentDocRoute.sidebar;var sidebarItems=sidebarName?versionMetadata.docsSidebars[sidebarName]:undefined;var docElement=(0,_docusaurus_renderRoutes__WEBPACK_IMPORTED_MODULE_3__/* .renderRoutes */ .v)(docRoutes);return{docElement:docElement,sidebarName:sidebarName,sidebarItems:sidebarItems};}/**
...
const globalData_namespaceObject = /*#__PURE__*/JSON.parse('{"docusaurus-plugin-content-docs":{"default":{"path":"/docs","versions":[{"name":"current","label":"Next","isLast":true,"path":"/docs","mainDocId":"intro","docs":[{"id":"intro","path":"/docs/intro","sidebar":"tutorialSidebar"},{"id":"Module 5-Physical AI/week18-physical-ai-foundations","path":"/docs/Module 5-Physical AI/week18-physical-ai-foundations","sidebar":"tutorialSidebar"},{"id":"Module 5-Physical AI/week19-perception-action-loops","path":"/docs/Module 5-Physical AI/week19-perception-action-loops","sidebar":"tutorialSidebar"},{"id":"Module 5-Physical AI/week20-real-environment-intelligence","path":"/docs/Module 5-Physical AI/week20-real-environment-intelligence","sidebar":"tutorialSidebar"},{"id":"module-1-ros2/week1-introduction","path":"/docs/module-1-ros2/week1-introduction","sidebar":"tutorialSidebar"},{"id":"module-1-ros2/week2-physical-ai-landscape","path":"/docs/module-1-ros2/week2-physical-ai-landscape","sidebar":"tutorialSidebar"},{"id":"module-1-ros2/week3-ros2-architecture-nodes","path":"/docs/module-1-ros2/week3-ros2-architecture-nodes","sidebar":"tutorialSidebar"},{"id":"module-1-ros2/week4-ros2-topics-services","path":"/docs/module-1-ros2/week4-ros2-topics-services","sidebar":"tutorialSidebar"},{"id":"module-1-ros2/week5-ros2-advanced-patterns","path":"/docs/module-1-ros2/week5-ros2-advanced-patterns","sidebar":"tutorialSidebar"},{"id":"module-2-gazebo/week6-simulation-concepts","path":"/docs/module-2-gazebo/week6-simulation-concepts","sidebar":"tutorialSidebar"},{"id":"module-2-gazebo/week7-robot-modeling-urdf","path":"/docs/module-2-gazebo/week7-robot-modeling-urdf","sidebar":"tutorialSidebar"},{"id":"module-2-gazebo/week8-gazebo-sensors","path":"/docs/module-2-gazebo/week8-gazebo-sensors","sidebar":"tutorialSidebar"},{"id":"module-2-gazebo/week9-gazebo-controllers","path":"/docs/module-2-gazebo/week9-gazebo-controllers","sidebar":"tutorialSidebar"},{"id":"module-3-nvidia-isaac/week10-intro-isaac-sim","path":"/docs/module-3-nvidia-isaac/week10-intro-isaac-sim","sidebar":"tutorialSidebar"},{"id":"module-3-nvidia-isaac/week11-isaac-pipeline-usd","path":"/docs/module-3-nvidia-isaac/week11-isaac-pipeline-usd","sidebar":"tutorialSidebar"},{"id":"module-3-nvidia-isaac/week12-isaac-perception-sensors","path":"/docs/module-3-nvidia-isaac/week12-isaac-perception-sensors","sidebar":"tutorialSidebar"},{"id":"module-3-nvidia-isaac/week13-isaac-robotics-ai","path":"/docs/module-3-nvidia-isaac/week13-isaac-robotics-ai","sidebar":"tutorialSidebar"},{"id":"module-4-humanoids/week14-humanoid-foundations","path":"/docs/module-4-humanoids/week14-humanoid-foundations","sidebar":"tutorialSidebar"},{"id":"module-4-humanoids/week15-biped-locomotion","path":"/docs/module-4-humanoids/week15-biped-locomotion","sidebar":"tutorialSidebar"},{"id":"module-4-humanoids/week16-humanoid-manipulation","path":"/docs/module-4-humanoids/week16-humanoid-manipulation","sidebar":"tutorialSidebar"},{"id":"module-4-humanoids/week17-humanoid-vision-learning","path":"/docs/module-4-humanoids/week17-humanoid-vision-learning","sidebar":"tutorialSidebar"},{"id":"tutorial-basics/congratulations","path":"/docs/tutorial-basics/congratulations"},{"id":"tutorial-basics/create-a-blog-post","path":"/docs/tutorial-basics/create-a-blog-post"},{"id":"tutorial-basics/create-a-document","path":"/docs/tutorial-basics/create-a-document"},{"id":"tutorial-basics/create-a-page","path":"/docs/tutorial-basics/create-a-page"},{"id":"tutorial-basics/deploy-your-site","path":"/docs/tutorial-basics/deploy-your-site"},{"id":"tutorial-basics/markdown-features","path":"/docs/tutorial-basics/markdown-features"},{"id":"tutorial-extras/manage-docs-versions","path":"/docs/tutorial-extras/manage-docs-versions"},{"id":"tutorial-extras/translate-your-site","path":"/docs/tutorial-extras/translate-your-site"}],"draftIds":[],"sidebars":{"tutorialSidebar":{"link":{"path":"/docs/intro","label":"Welcome to the Physical AI & Humanoid Robotics Textbook"}}}}],"breadcrumbs":true}}}');
;// ./.docusaurus/i18n.json
const i18n_namespaceObject = /*#__PURE__*/JSON.parse('{"defaultLocale":"en","locales":["en"],"path":"i18n","currentLocale":"en","localeConfigs":{"en":{"label":"English","direction":"ltr","htmlLang":"en","calendar":"gregory","path":"en","translate":false,"url":"https://your-docusaurus-site.example.com","baseUrl":"/"}}}');
// EXTERNAL MODULE: ./.docusaurus/codeTranslations.json
var codeTranslations = __webpack_require__(2654);
;// ./.docusaurus/site-metadata.json
const site_metadata_namespaceObject = /*#__PURE__*/JSON.parse('{"docusaurusVersion":"3.9.2","siteVersion":"1.0.0","pluginVersions":{"docusaurus-plugin-content-docs":{"type":"package","name":"@docusaurus/plugin-content-docs","version":"3.9.2"},"docusaurus-plugin-content-blog":{"type":"package","name":"@docusaurus/plugin-content-blog","version":"3.9.2"},"docusaurus-plugin-content-pages":{"type":"package","name":"@docusaurus/plugin-content-pages","version":"3.9.2"},"docusaurus-plugin-sitemap":{"type":"package","name":"@docusaurus/plugin-sitemap","version":"3.9.2"},"docusaurus-plugin-svgr":{"type":"package","name":"@docusaurus/plugin-svgr","version":"3.9.2"},"docusaurus-theme-classic":{"type":"package","name":"@docusaurus/theme-classic","version":"3.9.2"},"disable-minification":{"type":"local"}}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(4848);
 ...
 */function useHistoryActionHandler(handler){var history=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_2__/* .useHistory */ .W6)();var stableHandler=(0,_reactUtils__WEBPACK_IMPORTED_MODULE_3__/* .useEvent */ ._q)(handler);(0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(// See https://github.com/remix-run/history/blob/main/docs/blocking-transitions.md
 ...
 * @param selector
 */function useHistorySelector(selector){var history=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_2__/* .useHistory */ .W6)();return (0,react__WEBPACK_IMPORTED_MODULE_1__.useSyncExternalStore)(history.listen,function(){return selector(history);},function(){return selector(Object.assign({},history,{location:Object.assign({},history.location,{// On the server/hydration, these attributes should always be empty
...
var arrayJsonString=useHistorySelector(function(history){var values=new URLSearchParams(history.location.search).getAll(key);return JSON.stringify(values);});return useMemo(function(){return JSON.parse(arrayJsonString);},[arrayJsonString]);}function useQueryStringListUpdater(key){var history=useHistory();var setValues=useCallback(function(update,options){var searchParams=new URLSearchParams(history.location.search);var newValues=Array.isArray(update)?update:update(searchParams.getAll(key));searchParams["delete"](key);newValues.forEach(function(v){return searchParams.append(key,v);});var updateHistory=options!=null&&options.push?history.push:history.replace;updateHistory({search:searchParams.toString()});},[history,key]);return setValues;}function useQueryStringList(key){var values=useQueryStringListValues(key);var setValues=useQueryStringListUpdater(key);return[values,setValues];}function useClearQueryString(){var history=useHistory();return useCallback(function(){history.replace({search:undefined});},[history]);}function mergeSearchParams(params,strategy){var result=new URLSearchParams();for(var _iterator=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelperLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(params),_step;!(_step=_iterator()).done;){var item=_step.value;for(var _iterator2=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelperLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(item.entries()),_step2;!(_step2=_iterator2()).done;){var _step2$value=_step2.value,key=_step2$value[0],value=_step2$value[1];if(strategy==='append'){result.append(key,value);}else{result.set(key,value);}}}return result;}function mergeSearchStrings(searchStrings,strategy){var params=mergeSearchParams(searchStrings.map(function(s){return new URLSearchParams(s!=null?s:'');}),strategy);var str=params.toString();return str?"?"+str:str;}
...
/* harmony default export */ const registry = ({"0058b4c6":[function(){return __webpack_require__.e(/* import() | 0058b4c6 */ 849).then(__webpack_require__.t.bind(__webpack_require__, 6164, 19));},"@generated/docusaurus-plugin-content-docs/default/p/docs-175.json",/*require.resolve*/(6164)],"01a85c17":[function(){return Promise.all(/* import() | 01a85c17 */[__webpack_require__.e(1869), __webpack_require__.e(8209)]).then(__webpack_require__.bind(__webpack_require__, 9158));},"@theme/BlogTagsListPage",/*require.resolve*/(9158)],"0e384e19":[function(){return __webpack_require__.e(/* import() | 0e384e19 */ 3976).then(__webpack_require__.bind(__webpack_require__, 2053));},"@site/docs/intro.md",/*require.resolve*/(2053)],"17896441":[function(){return Promise.all(/* import() | 17896441 */[__webpack_require__.e(1869), __webpack_require__.e(7479), __webpack_require__.e(8401)]).then(__webpack_require__.bind(__webpack_require__, 8310));},"@theme/DocItem",/*require.resolve*/(8310)],"180f194e":[function(){return __webpack_require__.e(/* import() | 180f194e */ 4221).then(__webpack_require__.bind(__webpack_require__, 81));},"@site/docs/Module 5-Physical AI/week20-real-environment-intelligence.md",/*require.resolve*/(81)],"18c41134":[function(){return __webpack_require__.e(/* import() | 18c41134 */ 9262).then(__webpack_require__.bind(__webpack_require__, 8877));},"@site/docs/tutorial-basics/markdown-features.mdx",/*require.resolve*/(8877)],"1dea6ca3":[function(){return __webpack_require__.e(/* import() | 1dea6ca3 */ 5407).then(__webpack_require__.t.bind(__webpack_require__, 6067, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-authors-yangshun-af2.json",/*require.resolve*/(6067)],"1df93b7f":[function(){return Promise.all(/* import() | 1df93b7f */[__webpack_require__.e(1869), __webpack_require__.e(4583)]).then(__webpack_require__.bind(__webpack_require__, 5579));},"@site/src/pages/index.tsx",/*require.resolve*/(5579)],"1e4232ab":[function(){return __webpack_require__.e(/* import() | 1e4232ab */ 1953).then(__webpack_require__.bind(__webpack_require__, 6546));},"@site/docs/tutorial-basics/create-a-document.md",/*require.resolve*/(6546)],"1f391b9e":[function(){return Promise.all(/* import() | 1f391b9e */[__webpack_require__.e(1869), __webpack_require__.e(7479), __webpack_require__.e(6061)]).then(__webpack_require__.bind(__webpack_require__, 7973));},"@theme/MDXPage",/*require.resolve*/(7973)],"20482497":[function(){return __webpack_require__.e(/* import() | 20482497 */ 3171).then(__webpack_require__.bind(__webpack_require__, 1876));},"@site/docs/module-4-humanoids/week16-humanoid-manipulation.md",/*require.resolve*/(1876)],"218c9838":[function(){return __webpack_require__.e(/* import() | 218c9838 */ 5117).then(__webpack_require__.bind(__webpack_require__, 8741));},"@site/docs/module-1-ros2/week4-ros2-topics-services.md",/*require.resolve*/(8741)],"3217192f":[function(){return __webpack_require__.e(/* import() | 3217192f */ 8462).then(__webpack_require__.t.bind(__webpack_require__, 8174, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-tags-docusaurus-f20.json",/*require.resolve*/(8174)],"33fc5bb8":[function(){return Promise.all(/* import() | 33fc5bb8 */[__webpack_require__.e(1869), __webpack_require__.e(7479), __webpack_require__.e(3269), __webpack_require__.e(867)]).then(__webpack_require__.bind(__webpack_require__, 778));},"@theme/Blog/Pages/BlogAuthorsPostsPage",/*require.resolve*/(778)],"36994c47":[function(){return __webpack_require__.e(/* import() | 36994c47 */ 9858).then(__webpack_require__.t.bind(__webpack_require__, 5516, 19));},"@generated/docusaurus-plugin-content-blog/default/__plugin.json",/*require.resolve*/(5516)],"393be207":[function(){return __webpack_require__.e(/* import() | 393be207 */ 4134).then(__webpack_require__.bind(__webpack_require__, 591));},"@site/src/pages/markdown-page.md",/*require.resolve*/(591)],"3a2db09e":[function(){return __webpack_require__.e(/* import() | 3a2db09e */ 8121).then(__webpack_require__.t.bind(__webpack_require__, 8070, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-tags-df9.json",/*require.resolve*/(8070)],"3adc2175":[function(){return __webpack_require__.e(/* import() | 3adc2175 */ 6543).then(__webpack_require__.bind(__webpack_require__, 798));},"@site/docs/module-1-ros2/week1-introduction.md",/*require.resolve*/(798)],"3dd47ec8":[function(){return __webpack_require__.e(/* import() | 3dd47ec8 */ 2567).then(__webpack_require__.bind(__webpack_require__, 3243));},"@site/docs/module-4-humanoids/week15-biped-locomotion.md",/*require.resolve*/(3243)],"46fab1df":[function(){return __webpack_require__.e(/* import() | 46fab1df */ 2127).then(__webpack_require__.bind(__webpack_require__, 3402));},"@site/docs/module-3-nvidia-isaac/week13-isaac-robotics-ai.md",/*require.resolve*/(3402)],"51423826":[function(){return __webpack_require__.e(/* import() | 51423826 */ 7730).then(__webpack_require__.bind(__webpack_require__, 1248));},"@site/docs/module-3-nvidia-isaac/week10-intro-isaac-sim.md",/*require.resolve*/(1248)],"522c9417":[function(){return __webpack_require__.e(/* import() | 522c9417 */ 4876).then(__webpack_require__.bind(__webpack_require__, 7147));},"@site/docs/module-2-gazebo/week7-robot-modeling-urdf.md",/*require.resolve*/(7147)],"533a09ca":[function(){return __webpack_require__.e(/* import() | 533a09ca */ 3098).then(__webpack_require__.bind(__webpack_require__, 6633));},"@site/docs/tutorial-basics/create-a-blog-post.md",/*require.resolve*/(6633)],"59362658":[function(){return __webpack_require__.e(/* import() | 59362658 */ 9325).then(__webpack_require__.bind(__webpack_require__, 1180));},"@site/blog/2021-08-01-mdx-blog-post.mdx",/*require.resolve*/(1180)],"5c071cef":[function(){return __webpack_require__.e(/* import() | 5c071cef */ 6973).then(__webpack_require__.bind(__webpack_require__, 1049));},"@site/docs/module-2-gazebo/week8-gazebo-sensors.md",/*require.resolve*/(1049)],"5c868d36":[function(){return __webpack_require__.e(/* import() | 5c868d36 */ 1974).then(__webpack_require__.bind(__webpack_require__, 9516));},"@site/docs/tutorial-basics/create-a-page.md",/*require.resolve*/(9516)],"5e90a9b3":[function(){return __webpack_require__.e(/* import() | 5e90a9b3 */ 8025).then(__webpack_require__.t.bind(__webpack_require__, 7134, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-tags-hola-73f.json",/*require.resolve*/(7134)],"5e95c892":[function(){return __webpack_require__.e(/* import() | 5e95c892 */ 9647).then(__webpack_require__.bind(__webpack_require__, 7121));},"@theme/DocsRoot",/*require.resolve*/(7121)],"5e9f5e1a":[function(){return Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 4784));},"@generated/docusaurus.config",/*require.resolve*/(4784)],"621db11d":[function(){return Promise.all(/* import() | 621db11d */[__webpack_require__.e(1869), __webpack_require__.e(3269), __webpack_require__.e(4212)]).then(__webpack_require__.bind(__webpack_require__, 3250));},"@theme/Blog/Pages/BlogAuthorsListPage",/*require.resolve*/(3250)],"6875c492":[function(){return Promise.all(/* import() | 6875c492 */[__webpack_require__.e(1869), __webpack_require__.e(7479), __webpack_require__.e(3269), __webpack_require__.e(4813)]).then(__webpack_require__.bind(__webpack_require__, 3069));},"@theme/BlogTagsPostsPage",/*require.resolve*/(3069)],"6f7d680a":[function(){return Promise.all(/* import() | 6f7d680a */[__webpack_require__.e(1869), __webpack_require__.e(3120), __webpack_require__.e(8777)]).then(__webpack_require__.bind(__webpack_require__, 9930));},"@site/src/pages/signin.tsx",/*require.resolve*/(9930)],"73664a40":[function(){return __webpack_require__.e(/* import() | 73664a40 */ 1972).then(__webpack_require__.bind(__webpack_require__, 9581));},"@site/blog/2019-05-29-long-blog-post.md",/*require.resolve*/(9581)],"7661071f":[function(){return __webpack_require__.e(/* import() | 7661071f */ 8737).then(__webpack_require__.bind(__webpack_require__, 4137));},"@site/blog/2021-08-26-welcome/index.md?truncated=true",/*require.resolve*/(4137)],"7b36d7d3":[function(){return __webpack_require__.e(/* import() | 7b36d7d3 */ 2255).then(__webpack_require__.bind(__webpack_require__, 8192));},"@site/docs/module-2-gazebo/week6-simulation-concepts.md",/*require.resolve*/(8192)],"7ffc8b6c":[function(){return __webpack_require__.e(/* import() | 7ffc8b6c */ 5214).then(__webpack_require__.bind(__webpack_require__, 8559));},"@site/docs/module-1-ros2/week2-physical-ai-landscape.md",/*require.resolve*/(8559)],"814f3328":[function(){return __webpack_require__.e(/* import() | 814f3328 */ 7472).then(__webpack_require__.t.bind(__webpack_require__, 5513, 19));},"~blog/default/blog-post-list-prop-default.json",/*require.resolve*/(5513)],"822bd8ab":[function(){return __webpack_require__.e(/* import() | 822bd8ab */ 2748).then(__webpack_require__.bind(__webpack_require__, 3184));},"@site/docs/tutorial-basics/congratulations.md",/*require.resolve*/(3184)],"8717b14a":[function(){return __webpack_require__.e(/* import() | 8717b14a */ 3694).then(__webpack_require__.bind(__webpack_require__, 1615));},"@site/blog/2019-05-29-long-blog-post.md?truncated=true",/*require.resolve*/(1615)],"8d9bf57a":[function(){return Promise.all(/* import() | 8d9bf57a */[__webpack_require__.e(1869), __webpack_require__.e(3120), __webpack_require__.e(8353)]).then(__webpack_require__.bind(__webpack_require__, 3246));},"@site/src/pages/signup.tsx",/*require.resolve*/(3246)],"925b3f96":[function(){return __webpack_require__.e(/* import() | 925b3f96 */ 8609).then(__webpack_require__.bind(__webpack_require__, 5026));},"@site/blog/2019-05-28-first-blog-post.md?truncated=true",/*require.resolve*/(5026)],"92b35afe":[function(){return __webpack_require__.e(/* import() | 92b35afe */ 2750).then(__webpack_require__.bind(__webpack_require__, 4773));},"@site/docs/module-3-nvidia-isaac/week12-isaac-perception-sensors.md",/*require.resolve*/(4773)],"9e4087bc":[function(){return __webpack_require__.e(/* import() | 9e4087bc */ 2711).then(__webpack_require__.bind(__webpack_require__, 9331));},"@theme/BlogArchivePage",/*require.resolve*/(9331)],"a6aa9e1f":[function(){return Promise.all(/* import() | a6aa9e1f */[__webpack_require__.e(1869), __webpack_require__.e(7479), __webpack_require__.e(3269), __webpack_require__.e(7643)]).then(__webpack_require__.bind(__webpack_require__, 5124));},"@theme/BlogListPage",/*require.resolve*/(5124)],"a7456010":[function(){return __webpack_require__.e(/* import() | a7456010 */ 1235).then(__webpack_require__.t.bind(__webpack_require__, 8552, 19));},"@generated/docusaurus-plugin-content-pages/default/__plugin.json",/*require.resolve*/(8552)],"a7bd4aaa":[function(){return __webpack_require__.e(/* import() | a7bd4aaa */ 7098).then(__webpack_require__.bind(__webpack_require__, 1723));},"@theme/DocVersionRoot",/*require.resolve*/(1723)],"a94703ab":[function(){return Promise.all(/* import() | a94703ab */[__webpack_require__.e(1869), __webpack_require__.e(9048)]).then(__webpack_require__.bind(__webpack_require__, 8115));},"@theme/DocRoot",/*require.resolve*/(8115)],"aba21aa0":[function(){return __webpack_require__.e(/* import() | aba21aa0 */ 5742).then(__webpack_require__.t.bind(__webpack_require__, 7093, 19));},"@generated/docusaurus-plugin-content-docs/default/__plugin.json",/*require.resolve*/(7093)],"abd54b78":[function(){return __webpack_require__.e(/* import() | abd54b78 */ 8540).then(__webpack_require__.bind(__webpack_require__, 3932));},"@site/docs/module-4-humanoids/week17-humanoid-vision-learning.md",/*require.resolve*/(3932)],"acecf23e":[function(){return __webpack_require__.e(/* import() | acecf23e */ 1903).then(__webpack_require__.t.bind(__webpack_require__, 1912, 19));},"~blog/default/blogMetadata-default.json",/*require.resolve*/(1912)],"b4332287":[function(){return Promise.all(/* import() | b4332287 */[__webpack_require__.e(1869), __webpack_require__.e(660)]).then(__webpack_require__.bind(__webpack_require__, 2055));},"@site/src/pages/course-modules.tsx",/*require.resolve*/(2055)],"be981d16":[function(){return __webpack_require__.e(/* import() | be981d16 */ 9761).then(__webpack_require__.bind(__webpack_require__, 3657));},"@site/docs/module-1-ros2/week3-ros2-architecture-nodes.md",/*require.resolve*/(3657)],"c15d9823":[function(){return __webpack_require__.e(/* import() | c15d9823 */ 8146).then(__webpack_require__.t.bind(__webpack_require__, 9328, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-bd9.json",/*require.resolve*/(9328)],"c33a7516":[function(){return __webpack_require__.e(/* import() | c33a7516 */ 3784).then(__webpack_require__.bind(__webpack_require__, 8715));},"@site/docs/module-4-humanoids/week14-humanoid-foundations.md",/*require.resolve*/(8715)],"c9c9bef8":[function(){return __webpack_require__.e(/* import() | c9c9bef8 */ 1794).then(__webpack_require__.t.bind(__webpack_require__, 4971, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-authors-all-sebastien-lorber-articles-6eb.json",/*require.resolve*/(4971)],"cac0a167":[function(){return __webpack_require__.e(/* import() | cac0a167 */ 6365).then(__webpack_require__.bind(__webpack_require__, 1573));},"@site/docs/Module 5-Physical AI/week19-perception-action-loops.md",/*require.resolve*/(1573)],"ccc49370":[function(){return Promise.all(/* import() | ccc49370 */[__webpack_require__.e(1869), __webpack_require__.e(7479), __webpack_require__.e(3269), __webpack_require__.e(3249)]).then(__webpack_require__.bind(__webpack_require__, 3858));},"@theme/BlogPostPage",/*require.resolve*/(3858)],"d98bd9ec":[function(){return __webpack_require__.e(/* import() | d98bd9ec */ 8981).then(__webpack_require__.bind(__webpack_require__, 9568));},"@site/docs/Module 5-Physical AI/week18-physical-ai-foundations.md",/*require.resolve*/(9568)],"d9f32620":[function(){return __webpack_require__.e(/* import() | d9f32620 */ 5557).then(__webpack_require__.bind(__webpack_require__, 7447));},"@site/blog/2021-08-26-welcome/index.md",/*require.resolve*/(7447)],"db2345f2":[function(){return __webpack_require__.e(/* import() | db2345f2 */ 6109).then(__webpack_require__.bind(__webpack_require__, 9450));},"@site/docs/module-1-ros2/week5-ros2-advanced-patterns.md",/*require.resolve*/(9450)],"dff1c289":[function(){return __webpack_require__.e(/* import() | dff1c289 */ 1724).then(__webpack_require__.bind(__webpack_require__, 4126));},"@site/docs/tutorial-extras/manage-docs-versions.md",/*require.resolve*/(4126)],"e273c56f":[function(){return __webpack_require__.e(/* import() | e273c56f */ 9328).then(__webpack_require__.bind(__webpack_require__, 4014));},"@site/blog/2019-05-28-first-blog-post.md",/*require.resolve*/(4014)],"e44a2883":[function(){return __webpack_require__.e(/* import() | e44a2883 */ 4736).then(__webpack_require__.bind(__webpack_require__, 3274));},"@site/docs/tutorial-extras/translate-your-site.md",/*require.resolve*/(3274)],"e5aefb32":[function(){return __webpack_require__.e(/* import() | e5aefb32 */ 3276).then(__webpack_require__.t.bind(__webpack_require__, 8539, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-tags-facebook-f47.json",/*require.resolve*/(8539)],"ef42623e":[function(){return Promise.all(/* import() | ef42623e */[__webpack_require__.e(1869), __webpack_require__.e(3120), __webpack_require__.e(2495)]).then(__webpack_require__.bind(__webpack_require__, 3894));},"@site/src/pages/forgot.tsx",/*require.resolve*/(3894)],"ef8b811a":[function(){return __webpack_require__.e(/* import() | ef8b811a */ 8947).then(__webpack_require__.t.bind(__webpack_require__, 6600, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-authors-790.json",/*require.resolve*/(6600)],"f4f34a3a":[function(){return __webpack_require__.e(/* import() | f4f34a3a */ 3637).then(__webpack_require__.bind(__webpack_require__, 5512));},"@site/blog/2021-08-01-mdx-blog-post.mdx?truncated=true",/*require.resolve*/(5512)],"f55d3e7a":[function(){return __webpack_require__.e(/* import() | f55d3e7a */ 8863).then(__webpack_require__.bind(__webpack_require__, 1357));},"@site/docs/tutorial-basics/deploy-your-site.md",/*require.resolve*/(1357)],"f81c1134":[function(){return __webpack_require__.e(/* import() | f81c1134 */ 8130).then(__webpack_require__.t.bind(__webpack_require__, 7735, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-archive-f05.json",/*require.resolve*/(7735)],"f82cd581":[function(){return __webpack_require__.e(/* import() | f82cd581 */ 4584).then(__webpack_require__.t.bind(__webpack_require__, 4035, 19));},"@generated/docusaurus-plugin-content-blog/default/p/blog-tags-hello-f96.json",/*require.resolve*/(4035)],"fa4cad99":[function(){return __webpack_require__.e(/* import() | fa4cad99 */ 4698).then(__webpack_require__.bind(__webpack_require__, 5350));},"@site/docs/module-3-nvidia-isaac/week11-isaac-pipeline-usd.md",/*require.resolve*/(5350)],"fb4678e3":[function(){return __webpack_require__.e(/* import() | fb4678e3 */ 2464).then(__webpack_require__.bind(__webpack_require__, 950));},"@site/docs/module-2-gazebo/week9-gazebo-controllers.md",/*require.resolve*/(950)]});
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(4848);
...
if(path==='*'){return lib_default()({loading:Loading,loader:function loader(){return __webpack_require__.e(/* import() */ 2237).then(__webpack_require__.bind(__webpack_require__, 2237));},modules:['@theme/NotFound'],webpack:function webpack(){return[/*require.resolve*/(2237)];},render:function render(loaded,props){var NotFound=loaded["default"];return/*#__PURE__*/(0,jsx_runtime.jsx)(client_routeContext/* RouteContextProvider */.W// Do we want a better name than native-default?
...
var flatChunkNames=(0,flat/* default */.A)(chunkNames);Object.entries(flatChunkNames).forEach(function(_ref){var keyPath=_ref[0],chunkName=_ref[1];var chunkRegistry=registry[chunkName];if(chunkRegistry){loader[keyPath]=chunkRegistry[0];modules.push(chunkRegistry[1]);optsWebpack.push(chunkRegistry[2]);}});return lib_default().Map({loading:Loading,loader:loader,modules:modules,webpack:function webpack(){return optsWebpack;},render:function render(loaded,props){// `loaded` will be a map from key path (as returned from the flattened
...
/* harmony default export */ const routes = ([{path:'/blog',component:ComponentCreator('/blog','b2f'),exact:true},{path:'/blog/archive',component:ComponentCreator('/blog/archive','182'),exact:true},{path:'/blog/authors',component:ComponentCreator('/blog/authors','0b7'),exact:true},{path:'/blog/authors/all-sebastien-lorber-articles',component:ComponentCreator('/blog/authors/all-sebastien-lorber-articles','4a1'),exact:true},{path:'/blog/authors/yangshun',component:ComponentCreator('/blog/authors/yangshun','a68'),exact:true},{path:'/blog/first-blog-post',component:ComponentCreator('/blog/first-blog-post','89a'),exact:true},{path:'/blog/long-blog-post',component:ComponentCreator('/blog/long-blog-post','9ad'),exact:true},{path:'/blog/mdx-blog-post',component:ComponentCreator('/blog/mdx-blog-post','e9f'),exact:true},{path:'/blog/tags',component:ComponentCreator('/blog/tags','287'),exact:true},{path:'/blog/tags/docusaurus',component:ComponentCreator('/blog/tags/docusaurus','704'),exact:true},{path:'/blog/tags/facebook',component:ComponentCreator('/blog/tags/facebook','858'),exact:true},{path:'/blog/tags/hello',component:ComponentCreator('/blog/tags/hello','299'),exact:true},{path:'/blog/tags/hola',component:ComponentCreator('/blog/tags/hola','00d'),exact:true},{path:'/blog/welcome',component:ComponentCreator('/blog/welcome','d2b'),exact:true},{path:'/course-modules',component:ComponentCreator('/course-modules','672'),exact:true},{path:'/forgot',component:ComponentCreator('/forgot','761'),exact:true},{path:'/markdown-page',component:ComponentCreator('/markdown-page','3d7'),exact:true},{path:'/signin',component:ComponentCreator('/signin','ba0'),exact:true},{path:'/signup',component:ComponentCreator('/signup','312'),exact:true},{path:'/docs',component:ComponentCreator('/docs','c95'),routes:[{path:'/docs',component:ComponentCreator('/docs','002'),routes:[{path:'/docs',component:ComponentCreator('/docs','d45'),routes:[{path:'/docs/intro',component:ComponentCreator('/docs/intro','61d'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/Module 5-Physical AI/week18-physical-ai-foundations',component:ComponentCreator('/docs/Module 5-Physical AI/week18-physical-ai-foundations','339'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/Module 5-Physical AI/week19-perception-action-loops',component:ComponentCreator('/docs/Module 5-Physical AI/week19-perception-action-loops','f13'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/Module 5-Physical AI/week20-real-environment-intelligence',component:ComponentCreator('/docs/Module 5-Physical AI/week20-real-environment-intelligence','981'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-1-ros2/week1-introduction',component:ComponentCreator('/docs/module-1-ros2/week1-introduction','d94'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-1-ros2/week2-physical-ai-landscape',component:ComponentCreator('/docs/module-1-ros2/week2-physical-ai-landscape','992'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-1-ros2/week3-ros2-architecture-nodes',component:ComponentCreator('/docs/module-1-ros2/week3-ros2-architecture-nodes','dd3'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-1-ros2/week4-ros2-topics-services',component:ComponentCreator('/docs/module-1-ros2/week4-ros2-topics-services','ecb'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-1-ros2/week5-ros2-advanced-patterns',component:ComponentCreator('/docs/module-1-ros2/week5-ros2-advanced-patterns','0d9'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-2-gazebo/week6-simulation-concepts',component:ComponentCreator('/docs/module-2-gazebo/week6-simulation-concepts','2fd'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-2-gazebo/week7-robot-modeling-urdf',component:ComponentCreator('/docs/module-2-gazebo/week7-robot-modeling-urdf','bd4'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-2-gazebo/week8-gazebo-sensors',component:ComponentCreator('/docs/module-2-gazebo/week8-gazebo-sensors','9cd'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-2-gazebo/week9-gazebo-controllers',component:ComponentCreator('/docs/module-2-gazebo/week9-gazebo-controllers','1a4'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-3-nvidia-isaac/week10-intro-isaac-sim',component:ComponentCreator('/docs/module-3-nvidia-isaac/week10-intro-isaac-sim','6bd'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-3-nvidia-isaac/week11-isaac-pipeline-usd',component:ComponentCreator('/docs/module-3-nvidia-isaac/week11-isaac-pipeline-usd','b06'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-3-nvidia-isaac/week12-isaac-perception-sensors',component:ComponentCreator('/docs/module-3-nvidia-isaac/week12-isaac-perception-sensors','2fd'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-3-nvidia-isaac/week13-isaac-robotics-ai',component:ComponentCreator('/docs/module-3-nvidia-isaac/week13-isaac-robotics-ai','d40'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-4-humanoids/week14-humanoid-foundations',component:ComponentCreator('/docs/module-4-humanoids/week14-humanoid-foundations','ea4'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-4-humanoids/week15-biped-locomotion',component:ComponentCreator('/docs/module-4-humanoids/week15-biped-locomotion','504'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-4-humanoids/week16-humanoid-manipulation',component:ComponentCreator('/docs/module-4-humanoids/week16-humanoid-manipulation','2d2'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/module-4-humanoids/week17-humanoid-vision-learning',component:ComponentCreator('/docs/module-4-humanoids/week17-humanoid-vision-learning','7af'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/tutorial-basics/congratulations',component:ComponentCreator('/docs/tutorial-basics/congratulations','70e'),exact:true},{path:'/docs/tutorial-basics/create-a-blog-post',component:ComponentCreator('/docs/tutorial-basics/create-a-blog-post','315'),exact:true},{path:'/docs/tutorial-basics/create-a-document',component:ComponentCreator('/docs/tutorial-basics/create-a-document','f86'),exact:true},{path:'/docs/tutorial-basics/create-a-page',component:ComponentCreator('/docs/tutorial-basics/create-a-page','9f6'),exact:true},{path:'/docs/tutorial-basics/deploy-your-site',component:ComponentCreator('/docs/tutorial-basics/deploy-your-site','b91'),exact:true},{path:'/docs/tutorial-basics/markdown-features',component:ComponentCreator('/docs/tutorial-basics/markdown-features','272'),exact:true},{path:'/docs/tutorial-extras/manage-docs-versions',component:ComponentCreator('/docs/tutorial-extras/manage-docs-versions','a34'),exact:true},{path:'/docs/tutorial-extras/translate-your-site',component:ComponentCreator('/docs/tutorial-extras/translate-your-site','739'),exact:true}]}]}]},{path:'/',component:ComponentCreator('/','e5f'),exact:true},{path:'*',component:ComponentCreator('*')}]);
...
/* harmony import */ var D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8587);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6540);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4625);
/* harmony import */ var _docusaurus_utils_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(440);
/* harmony import */ var _useDocusaurusContext__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4586);
/* harmony import */ var _isInternalUrl__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6654);
/* harmony import */ var _ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8193);
/* harmony import */ var _useBrokenLinks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3427);
/* harmony import */ var _useBaseUrl__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6025);
...
var shouldAddBaseUrlAutomatically=function shouldAddBaseUrlAutomatically(to){return to.startsWith('/');};function Link(_ref,forwardedRef){var _targetLink,_targetLink$startsWit,_targetLink3;var isNavLink=_ref.isNavLink,to=_ref.to,href=_ref.href,activeClassName=_ref.activeClassName,isActive=_ref.isActive,noBrokenLinkCheck=_ref['data-noBrokenLinkCheck'],_ref$autoAddBaseUrl=_ref.autoAddBaseUrl,autoAddBaseUrl=_ref$autoAddBaseUrl===void 0?true:_ref$autoAddBaseUrl,props=(0,D_Docusaurus_my_website_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_ref,_excluded);var _useDocusaurusContext=(0,_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A)(),siteConfig=_useDocusaurusContext.siteConfig;var trailingSlash=siteConfig.trailingSlash,baseUrl=siteConfig.baseUrl;var router=siteConfig.future.experimental_router;var _useBaseUrlUtils=(0,_useBaseUrl__WEBPACK_IMPORTED_MODULE_8__/* .useBaseUrlUtils */ .hH)(),withBaseUrl=_useBaseUrlUtils.withBaseUrl;var brokenLinks=(0,_useBrokenLinks__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)();var innerRef=(0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);(0,react__WEBPACK_IMPORTED_MODULE_1__.useImperativeHandle)(forwardedRef,function(){return innerRef.current;});// IMPORTANT: using to or href should not change anything
// For example, MDX links will ALWAYS give us the href props
// Using one prop or the other should not be used to distinguish
// internal links (/docs/myDoc) from external links (https://github.com)
var targetLinkUnprefixed=to||href;function maybeAddBaseUrl(str){return autoAddBaseUrl&&shouldAddBaseUrlAutomatically(str)?withBaseUrl(str):str;}var isInternal=(0,_isInternalUrl__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(targetLinkUnprefixed);// pathname:// is a special "protocol" we use to tell Docusaurus link
...
if(router==='hash'&&(_targetLink=targetLink)!=null&&_targetLink.startsWith('./')){var _targetLink2;targetLink=(_targetLink2=targetLink)==null?void 0:_targetLink2.slice(1);}if(targetLink&&isInternal){targetLink=(0,_docusaurus_utils_common__WEBPACK_IMPORTED_MODULE_3__/* .applyTrailingSlash */ .Ks)(targetLink,{trailingSlash:trailingSlash,baseUrl:baseUrl});}var preloaded=(0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(false);var LinkComponent=isNavLink?react_router_dom__WEBPACK_IMPORTED_MODULE_2__/* .NavLink */ .k2:react_router_dom__WEBPACK_IMPORTED_MODULE_2__/* .Link */ .N_;var IOSupported=_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.canUseIntersectionObserver;var ioRef=(0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)();var handleRef=function handleRef(el){innerRef.current=el;if(IOSupported&&el&&isInternal){// If IO supported and element reference found, set up Observer.
...
ioRef.current.observe(el);}};var onInteractionEnter=function onInteractionEnter(){if(!preloaded.current&&targetLink!=null){window.docusaurus.preload(targetLink);preloaded.current=true;}};(0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function(){// If IO is not supported. We prefetch by default (only once).
if(!IOSupported&&isInternal&&_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.canUseDOM){if(targetLink!=null){window.docusaurus.prefetch(targetLink);}}// When unmounting, stop intersection observer from watching.
...
(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("a",Object.assign({ref:innerRef,href:targetLink},targetLinkUnprefixed&&!isInternal&&{target:'_blank',rel:'noopener noreferrer'},props,testOnlyProps)):/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(LinkComponent,Object.assign({},props,{onMouseEnter:onInteractionEnter,onTouchStart:onInteractionEnter,innerRef:handleRef,to:targetLink// Avoid "React does not recognize the `activeClassName` prop on a DOM
// element"
},isNavLink&&{isActive:isActive,activeClassName:activeClassName},testOnlyProps));}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(Link));
...
/******/ __webpack_require__.O(0, [1869], () => (__webpack_exec__(1532)));
