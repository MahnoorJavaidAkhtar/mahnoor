"use strict";
(self["webpackChunkmy_website"] = self["webpackChunkmy_website"] || []).push([[3120],{
...
const _DEFAULT_AUTH_ERROR_FACTORY = new dist_index_esm/* ErrorFactory */.FA('auth', 'Firebase', _prodErrorMap());
/**
 ...
 * limitations under the License.
 */
const logClient = new esm_index_esm/* Logger */.Vy('@firebase/auth');
function _logWarn(msg, ...args) {
    if (logClient.logLevel <= esm_index_esm/* LogLevel */.$b.WARN) {
        logClient.warn(`Auth (${index_esm/* SDK_VERSION */.MF}): ${msg}`, ...args);
    }
}
function _logError(msg, ...args) {
    if (logClient.logLevel <= esm_index_esm/* LogLevel */.$b.ERROR) {
        logClient.error(`Auth (${index_esm/* SDK_VERSION */.MF}): ${msg}`, ...args);
    }
}
...
function _errorWithCustomMessage(auth, code, message) {
    ...
    const factory = new dist_index_esm/* ErrorFactory */.FA('auth', 'Firebase', errorMap);
...
function _isOnline() {
    if (typeof navigator !== 'undefined' &&
        ...
        (_isHttpOrHttps() || (0,dist_index_esm/* isBrowserExtension */.sr)() || 'connection' in navigator)) {
...
class Delay {
    constructor(shortDelay, longDelay) {
        ...
        this.isMobile = (0,dist_index_esm/* isMobileCordova */.jZ)() || (0,dist_index_esm/* isReactNative */.lV)();
    }
    get() {
        if (!_isOnline()) {
...
async function _performApiRequest(auth, method, path, request, customErrorMap = {}) {
    return _performFetchWithErrorHandling(auth, customErrorMap, async () => {
        ...
        const query = (0,dist_index_esm/* querystring */.Am)({
        ...
        if (!(0,dist_index_esm/* isCloudflareWorker */.c1)()) {
            fetchArgs.referrerPolicy = 'no-referrer';
        }
        if (auth.emulatorConfig && (0,dist_index_esm/* isCloudWorkstation */.zJ)(auth.emulatorConfig.host)) {
...
async function _performFetchWithErrorHandling(auth, customErrorMap, fetchFn) {
    ...
    try {
        ...
        if (e instanceof dist_index_esm/* FirebaseError */.g) {
            throw e;
        }
...
async function getIdTokenResult(user, forceRefresh = false) {
    const userInternal = (0,dist_index_esm/* getModularInstance */.Ku)(user);
...
function _parseToken(token) {
    ...
    try {
        const decoded = (0,dist_index_esm/* base64Decode */.u)(payload);
        if (!decoded) {
...
async function _logoutIfInvalidated(user, promise, bypassAuthState = false) {
    ...
    try {
        ...
        if (e instanceof dist_index_esm/* FirebaseError */.g && isUserInvalidated(e)) {
...
async function requestStsToken(auth, refreshToken) {
    const response = await _performFetchWithErrorHandling(auth, {}, async () => {
        const body = (0,dist_index_esm/* querystring */.Am)({
        ...
        if (auth.emulatorConfig &&
            (0,dist_index_esm/* isCloudWorkstation */.zJ)(auth.emulatorConfig.host)) {
...
class UserImpl {
    ...
    async delete() {
        if ((0,index_esm/* _isFirebaseServerApp */.xZ)(this.auth.app)) {
...
function _isFirefox(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
    return /firefox\//i.test(ua);
}
function _isSafari(userAgent = (0,dist_index_esm/* getUA */.ZQ)()) {
    const ua = userAgent.toLowerCase();
...
function _isChromeIOS(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
    return /crios\//i.test(ua);
}
function _isIEMobile(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
    return /iemobile/i.test(ua);
}
function _isAndroid(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
    return /android/i.test(ua);
}
function _isBlackBerry(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
    return /blackberry/i.test(ua);
}
function _isWebOS(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
    return /webos/i.test(ua);
}
function _isIOS(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
...
function _isIOSStandalone(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
    return _isIOS(ua) && !!window.navigator?.standalone;
}
function _isIE10() {
    return (0,dist_index_esm/* isIE */.lT)() && document.documentMode === 10;
}
function _isMobileBrowser(ua = (0,dist_index_esm/* getUA */.ZQ)()) {
...
function _getClientVersion(clientPlatform, frameworks = []) {
    ...
    switch (clientPlatform) {
        case "Browser" /* ClientPlatform.BROWSER */:
            ...
            reportedPlatform = _getBrowserName((0,dist_index_esm/* getUA */.ZQ)());
            break;
        case "Worker" /* ClientPlatform.WORKER */:
            // Technically a worker runs from a browser but we need to differentiate a
            // worker from a browser.
            // For example: Chrome-Worker/JsCore/4.9.1/FirebaseCore-web.
            reportedPlatform = `${_getBrowserName((0,dist_index_esm/* getUA */.ZQ)())}-${clientPlatform}`;
            break;
        default:
    ...
    return `${reportedPlatform}/${"JsCore" /* ClientImplementation.CORE */}/${index_esm/* SDK_VERSION */.MF}/${reportedFrameworks}`;
}
...
class AuthImpl {
    ...
    async initializeCurrentUser(popupRedirectResolver) {
        if ((0,index_esm/* _isFirebaseServerApp */.xZ)(this.app)) {
    ...
    async updateCurrentUser(userExtern) {
        ...
        const user = userExtern
            ? (0,dist_index_esm/* getModularInstance */.Ku)(userExtern)
            : null;
        if (user) {
    ...
    _updateErrorMap(errorMap) {
        this._errorFactory = new dist_index_esm/* ErrorFactory */.FA('auth', 'Firebase', errorMap());
    }
    ...
    async _getAppCheckToken() {
        if ((0,index_esm/* _isFirebaseServerApp */.xZ)(this.app) && this.app.settings.appCheckToken) {
...
function _castAuth(auth) {
    return (0,dist_index_esm/* getModularInstance */.Ku)(auth);
}
...
class Subscription {
    constructor(auth) {
        this.auth = auth;
        this.observer = null;
        this.addObserver = (0,dist_index_esm/* createSubscribe */.tD)(observer => (this.observer = observer));
    }
    get next() {
...
function initializeAuth(app, deps) {
    const provider = (0,index_esm/* _getProvider */.j6)(app, 'auth');
    if (provider.isInitialized()) {
        const auth = provider.getImmediate();
        const initialOptions = provider.getOptions();
        if ((0,dist_index_esm/* deepEqual */.bD)(initialOptions, deps ?? {})) {
            return auth;
        }
        else {
...
function connectAuthEmulator(auth, url, options) {
    ...
    if (!authInternal._canInitEmulator) {
        ...
        _assert((0,dist_index_esm/* deepEqual */.bD)(emulator, authInternal.config.emulator) &&
            (0,dist_index_esm/* deepEqual */.bD)(emulatorConfig, authInternal.emulatorConfig), authInternal, "emulator-config-failed" /* AuthErrorCode.EMULATOR_CONFIG_FAILED */);
    ...
    if ((0,dist_index_esm/* isCloudWorkstation */.zJ)(host)) {
        void (0,dist_index_esm/* pingServer */.gE)(`${protocol}//${host}${portStr}`);
        (0,dist_index_esm/* updateEmulatorBanner */.P1)('Auth', true);
    }
...
class OAuthCredential extends AuthCredential {
    ...
    buildRequest() {
        ...
        if (this.pendingToken) {
            ...
            request.postBody = (0,dist_index_esm/* querystring */.Am)(postBody);
        }
        return request;
    }
}
...
function parseDeepLink(url) {
    const link = (0,dist_index_esm/* querystringDecode */.I9)((0,dist_index_esm/* extractQuerystring */.hp)(url))['link'];
    // Double link case (automatic redirect).
    const doubleDeepLink = link
        ? (0,dist_index_esm/* querystringDecode */.I9)((0,dist_index_esm/* extractQuerystring */.hp)(link))['deep_link_id']
        : null;
    // iOS custom scheme links.
    const iOSDeepLink = (0,dist_index_esm/* querystringDecode */.I9)((0,dist_index_esm/* extractQuerystring */.hp)(url))['deep_link_id'];
    const iOSDoubleDeepLink = iOSDeepLink
        ? (0,dist_index_esm/* querystringDecode */.I9)((0,dist_index_esm/* extractQuerystring */.hp)(iOSDeepLink))['link']
        : null;
...
class ActionCodeURL {
    ...
    constructor(actionLink) {
        const searchParams = (0,dist_index_esm/* querystringDecode */.I9)((0,dist_index_esm/* extractQuerystring */.hp)(actionLink));
 ...
 * limitations under the License.
 */
class MultiFactorError extends dist_index_esm/* FirebaseError */.g {
...
async function _reauthenticate(user, credential, bypassAuthState = false) {
    const { auth } = user;
    if ((0,index_esm/* _isFirebaseServerApp */.xZ)(auth.app)) {
        return Promise.reject(_serverAppCurrentUserOperationNotSupportedError(auth));
    }
...
function signInWithEmailAndPassword(auth, email, password) {
    ...
    return signInWithCredential((0,dist_index_esm/* getModularInstance */.Ku)(auth), EmailAuthProvider.credential(email, password)).catch(async (error) => {
        if (error.code === `auth/${"password-does-not-meet-requirements" /* AuthErrorCode.PASSWORD_DOES_NOT_MEET_REQUIREMENTS */}`) {
            void recachePasswordPolicy(auth);
        }
        throw error;
...
function onIdTokenChanged(auth, nextOrObserver, error, completed) {
    return (0,dist_index_esm/* getModularInstance */.Ku)(auth).onIdTokenChanged(nextOrObserver, error, completed);
}
/**
...
function beforeAuthStateChanged(auth, callback, onAbort) {
    return (0,dist_index_esm/* getModularInstance */.Ku)(auth).beforeAuthStateChanged(callback, onAbort);
}
/**
...
class PhoneAuthProvider {
    ...
    verifyPhoneNumber(phoneOptions, applicationVerifier) {
        return _verifyPhoneNumber(this.auth, phoneOptions, (0,dist_index_esm/* getModularInstance */.Ku)(applicationVerifier));
    }
    /**
...
function getIframeUrl(auth) {
    ...
    return `${url}?${(0,dist_index_esm/* querystring */.Am)(params).slice(1)}`;
}
...
function _open(auth, url, name, width = DEFAULT_WIDTH, height = DEFAULT_HEIGHT) {
    ...
    const ua = (0,dist_index_esm/* getUA */.ZQ)().toLowerCase();
    if (name) {
...
async function _getRedirectUrl(auth, provider, authType, redirectUrl, eventId, additionalParams) {
    ...
    if (provider instanceof FederatedAuthProvider) {
        ...
        if (!(0,dist_index_esm/* isEmpty */.Im)(provider.getCustomParameters())) {
    ...
    return `${getHandlerBase(auth)}?${(0,dist_index_esm/* querystring */.Am)(paramsDict).slice(1)}${appCheckTokenFragment}`;
}
...
var index_1970027f_name = "@firebase/auth";
var version = "1.11.1";
...
function registerAuth(clientPlatform) {
    (0,index_esm/* _registerComponent */.om)(new dist_esm_index_esm/* Component */.uA("auth" /* _ComponentName.AUTH */, (container, { options: deps }) => {
    ...
    (0,index_esm/* _registerComponent */.om)(new dist_esm_index_esm/* Component */.uA("auth-internal" /* _ComponentName.AUTH_INTERNAL */, container => {
        const auth = _castAuth(container.getProvider("auth" /* _ComponentName.AUTH */).getImmediate());
        return (auth => new AuthInterop(auth))(auth);
    }, "PRIVATE" /* ComponentType.PRIVATE */).setInstantiationMode("EXPLICIT" /* InstantiationMode.EXPLICIT */));
    (0,index_esm/* registerVersion */.KO)(index_1970027f_name, version, getVersionForPlatform(clientPlatform));
    // BUILD_TARGET will be replaced by values like esm, cjs, etc during the compilation
    (0,index_esm/* registerVersion */.KO)(index_1970027f_name, version, 'esm2020');
}
...
const authIdTokenMaxAge = (0,dist_index_esm/* getExperimentalSetting */.XA)('authIdTokenMaxAge') || DEFAULT_ID_TOKEN_MAX_AGE;
 ...
 * @public
 */
function getAuth(app = (0,index_esm/* getApp */.Sx)()) {
    const provider = (0,index_esm/* _getProvider */.j6)(app, 'auth');
    if (provider.isInitialized()) {
    ...
    const authTokenSyncPath = (0,dist_index_esm/* getExperimentalSetting */.XA)('authTokenSyncURL');
    ...
    const authEmulatorHost = (0,dist_index_esm/* getDefaultEmulatorHost */.Tj)('auth');
    if (authEmulatorHost) {
...
// UNUSED EXPORTS: FirebaseError, _DEFAULT_ENTRY_NAME, _addComponent, _addOrOverwriteComponent, _apps, _clearComponents, _components, _isFirebaseApp, _isFirebaseServerAppSettings, _removeServiceInstance, _serverApps, deleteApp, initializeServerApp, onLog, setLogLevel

// EXTERNAL MODULE: ../node_modules/@firebase/component/dist/esm/index.esm.js
var index_esm = __webpack_require__(4873);
// EXTERNAL MODULE: ../node_modules/@firebase/logger/dist/esm/index.esm.js
var esm_index_esm = __webpack_require__(7812);
// EXTERNAL MODULE: ../node_modules/@firebase/util/dist/index.esm.js + 1 modules
var dist_index_esm = __webpack_require__(8970);
 ...
 * limitations under the License.
 */
const logger = new esm_index_esm/* Logger */.Vy('@firebase/app');
...
const ERROR_FACTORY = new dist_index_esm/* ErrorFactory */.FA('app', 'Firebase', ERRORS);
...
class FirebaseAppImpl {
    constructor(options, config, container) {
        ...
        this.container.addComponent(new index_esm/* Component */.uA('app', () => this, "PUBLIC" /* ComponentType.PUBLIC */));
    }
...
function validateTokenTTL(base64Token, tokenName) {
    const secondPart = (0,dist_index_esm/* base64Decode */.u)(base64Token.split('.')[1]);
    if (secondPart === null) {
...
function initializeApp(_options, rawConfig = {}) {
    ...
    options || (options = (0,dist_index_esm/* getDefaultAppConfig */.T9)());
    if (!options) {
    ...
    if (existingApp) {
        ...
        if ((0,dist_index_esm/* deepEqual */.bD)(options, existingApp.options) &&
            (0,dist_index_esm/* deepEqual */.bD)(config, existingApp.config)) {
            return existingApp;
        }
        else {
    ...
    const container = new index_esm/* ComponentContainer */.h1(name);
...
function getApp(name = DEFAULT_ENTRY_NAME) {
    ...
    if (!app && name === DEFAULT_ENTRY_NAME && (0,dist_index_esm/* getDefaultAppConfig */.T9)()) {
...
function registerVersion(libraryKeyOrName, version, variant) {
    ...
    _registerComponent(new index_esm/* Component */.uA(`${library}-version`, () => ({ library, version }), "VERSION" /* ComponentType.VERSION */));
}
/**
...
class HeartbeatServiceImpl {
    ...
    async getHeartbeatsHeader() {
        try {
            ...
            const headerString = (0,dist_index_esm/* base64urlEncodeWithoutPadding */.Uj)(JSON.stringify({ version: 2, heartbeats: heartbeatsToSend }));
...
class HeartbeatStorageImpl {
    ...
    async runIndexedDBEnvironmentCheck() {
        if (!(0,dist_index_esm/* isIndexedDBAvailable */.zW)()) {
            return false;
        }
        else {
            return (0,dist_index_esm/* validateIndexedDBOpenable */.eX)()
                .then(() => true)
                .catch(() => false);
        }
    }
...
function countBytes(heartbeatsCache) {
    ...
    return (0,dist_index_esm/* base64urlEncodeWithoutPadding */.Uj)(
...
function registerCoreComponents(variant) {
    _registerComponent(new index_esm/* Component */.uA('platform-logger', container => new PlatformLoggerServiceImpl(container), "PRIVATE" /* ComponentType.PRIVATE */));
    _registerComponent(new index_esm/* Component */.uA('heartbeat', container => new HeartbeatServiceImpl(container), "PRIVATE" /* ComponentType.PRIVATE */));
...
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8970);
...
/* harmony export */ });
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(881);
...
// UNUSED EXPORTS: CONSTANTS, DecodeBase64StringError, MAX_VALUE_MILLIS, RANDOM_FACTOR, Sha1, areCookiesEnabled, assert, assertionError, async, base64, base64Encode, calculateBackoffMillis, contains, createMockUserToken, decode, deepCopy, deepExtend, errorPrefix, getDefaultEmulatorHostnameAndPort, getDefaults, getGlobal, isAdmin, isBrowser, isElectron, isNode, isNodeSdk, isSafari, isSafariOrWebkit, isUWP, isValidFormat, isValidTimestamp, isWebWorker, issuedAtTime, jsonEval, map, ordinal, promiseWithTimeout, safeGet, stringLength, stringToByteArray, stringify, validateArgCount, validateCallback, validateContextObject, validateNamespace
